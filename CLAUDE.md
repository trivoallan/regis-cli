...
- `thoughts/` is gitignored — internal planning and client-specific content lives here, never commit it.
...
- **Trunk MD036**: `**bold text**` on its own line in Markdown triggers markdownlint MD036 (emphasis-as-heading). Use `>` blockquote or plain text instead.

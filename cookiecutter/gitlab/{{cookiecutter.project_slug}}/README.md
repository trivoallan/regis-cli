...
- **Metadata Traceability**: Reports automatically include GitLab CI metadata (requester, workflow, run ID) for better auditability.
- **Automatic Publishing**: Generated reports are committed back to the repository and automatically published to **GitLab Pages**.

To view your reports, enable GitLab Pages in your repository settings and point it to the "GitLab CI" source.

...
[TIP]
====
To quickly bootstrap a new GitHub repository pre-configured with `regis-cli` and GitHub Actions, you can use our xref:../commands.adoc#bootstrap[Project Bootstrapping] command.
====

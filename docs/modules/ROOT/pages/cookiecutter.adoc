...
Run Cookiecutter pointing to the platform-specific directory in this repository:

[source,bash]
----
# For GitHub
pipenv run cookiecutter cookiecutter/github/
...
[NOTE]
====
Platform-specific templates include pre-configured CI/CD workflows (GitHub Actions or GitLab CI) and optimized directory structures.
====

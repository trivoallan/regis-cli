  ...
  [553],
  {
    553(e, t, r) {
        ...
        h = (e) =>
          "ordgroup" === e.type || "color" === e.type
            ...
            : "font" === e.type
              ? h(e.body)
              : e,
        m = new Set(["mathord", "textord", "atom"]),
        c = (e) => m.has(h(e).type),
        u = {
          displayMode: {
            type: "boolean",
      ...
      class d {
        constructor(e) {
          ...
          Object.keys(u))) {
            var r = u[t],
              a = e[t];
            this[t] = void 0 !== a ? (r.processor ? r.processor(a) : a) : p(r);
          }
        }
        reportNonstrict(e, t, r) {
          var n = this.strict;
          if (
            ("function" == typeof n && (n = n(e, t, r)), n && "ignore" !== n)
          ) {
            if (!0 === n || "error" === n)
              throw new a(
      ...
      var C = {
        ...
        P = function (e) {
          var t = "<" + e;
          this.classes.length && (t += ' class="' + l(N(this.classes)) + '"');
          var r = "";
          for (var n of Object.keys(this.style))
            r += i(n) + ":" + this.style[n] + ";";
          for (var o of (r && (t += ' style="' + l(r) + '"'),
          Object.keys(this.attributes))) {
            if (L.test(o)) throw new a("Invalid attribute name '" + o + "'");
            t += " " + o + '="' + l(this.attributes[o]) + '"';
          }
          t += ">";
      ...
      class V {
        constructor(e, t, r, a) {
          (O.call(this, e, r, a), (this.children = t || []));
        }
        setAttribute(e, t) {
          this.attributes[e] = t;
        }
      ...
      class G {
        ...
        toMarkup() {
          var e = '<img src="' + l(this.src) + '" alt="' + l(this.alt) + '"',
            t = "";
          for (var r of Object.keys(this.style))
            t += i(r) + ":" + this.style[r] + ";";
          return (t && (e += ' style="' + l(t) + '"'), (e += "'/>"));
        }
      }
      var U = {
        "\xee": "\u0131\u0302",
      ...
      class Y {
        ...
        toNode() {
          var e = document.createTextNode(this.text),
            t = null;
          for (var r of (this.italic > 0 &&
            ((t = document.createElement("span")).style.marginRight = E(
              this.italic,
            )),
          this.classes.length > 0 &&
            ((t = t || document.createElement("span")).className = N(
              this.classes,
            )),
          Object.keys(this.style)))
      ...
      class X {
        ...
        toMarkup() {
          return this.alternate
            ? '<path d="' + l(this.alternate) + '"/>'
            : '<path d="' + l(B[this.pathName]) + '"/>';
        }
      }
      class j {
        constructor(e) {
      ...
      function K(e, t, r) {
        ...
        var a = e.charCodeAt(0),
          n = _[t][a];
        if (
          (!n && e[0] in Z && ((a = Z[e[0]].charCodeAt(0)), (n = _[t][a])),
          n || "text" !== r || (A(a) && (n = _[t][77])),
          n)
        )
          return {
            depth: n[0],
      ...
      function re(e, t, r, a, n, i) {
        ((te[e][n] = { font: t, group: r, replace: a }),
          i && a && (te[e][a] = te[e][n]));
      }
      var ae = "math",
        ne = "text",
      ...
      (re(ae, ie, ge, "\u2261", "\\equiv", !0),
        ...
        re(ae, ie, ge, "\u223c", "\\sim", !0),
        re(ae, ie, ge, "\u22a5", "\\perp"),
        re(ae, ie, ge, "\u2aaf", "\\preceq", !0),
        re(ae, ie, ge, "\u2ab0", "\\succeq", !0),
        re(ae, ie, ge, "\u2243", "\\simeq", !0),
        re(ae, ie, ge, "\u2223", "\\mid", !0),
        re(ae, ie, ge, "\u226a", "\\ll", !0),
        re(ae, ie, ge, "\u226b", "\\gg", !0),
        re(ae, ie, ge, "\u224d", "\\asymp", !0),
        re(ae, ie, ge, "\u2225", "\\parallel"),
        re(ae, ie, ge, "\u22c8", "\\bowtie", !0),
        re(ae, ie, ge, "\u2323", "\\smile", !0),
        re(ae, ie, ge, "\u2291", "\\sqsubseteq", !0),
        re(ae, ie, ge, "\u2292", "\\sqsupseteq", !0),
        re(ae, ie, ge, "\u2250", "\\doteq", !0),
        re(ae, ie, ge, "\u2322", "\\frown", !0),
        re(ae, ie, ge, "\u220b", "\\ni", !0),
        re(ae, ie, ge, "\u221d", "\\propto", !0),
        re(ae, ie, ge, "\u22a2", "\\vdash", !0),
        re(ae, ie, ge, "\u22a3", "\\dashv", !0),
        re(ae, ie, ge, "\u220b", "\\owns"),
        re(ae, ie, de, ".", "\\ldotp"),
        ...
        re(ae, ie, ve, "&", "\\&"),
        re(ne, ie, ve, "&", "\\&"),
        re(ae, ie, ve, "\u2135", "\\aleph", !0),
        re(ae, ie, ve, "\u2200", "\\forall", !0),
        re(ae, ie, ve, "\u210f", "\\hbar", !0),
        re(ae, ie, ve, "\u2203", "\\exists", !0),
        re(ae, ie, ve, "\u2207", "\\nabla", !0),
        re(ae, ie, ve, "\u266d", "\\flat", !0),
        re(ae, ie, ve, "\u2113", "\\ell", !0),
        re(ae, ie, ve, "\u266e", "\\natural", !0),
        re(ae, ie, ve, "\u2663", "\\clubsuit", !0),
        re(ae, ie, ve, "\u2118", "\\wp", !0),
        re(ae, ie, ve, "\u266f", "\\sharp", !0),
        re(ae, ie, ve, "\u2662", "\\diamondsuit", !0),
        re(ae, ie, ve, "\u211c", "\\Re", !0),
        re(ae, ie, ve, "\u2661", "\\heartsuit", !0),
        re(ae, ie, ve, "\u2111", "\\Im", !0),
        re(ae, ie, ve, "\u2660", "\\spadesuit", !0),
        re(ae, ie, ve, "\xa7", "\\S", !0),
        re(ne, ie, ve, "\xa7", "\\S"),
        re(ae, ie, ve, "\xb6", "\\P", !0),
        re(ne, ie, ve, "\xb6", "\\P"),
        re(ae, ie, ve, "\u2020", "\\dag"),
        re(ne, ie, ve, "\u2020", "\\dag"),
        re(ne, ie, ve, "\u2020", "\\textdagger"),
        re(ae, ie, ve, "\u2021", "\\ddag"),
        re(ne, ie, ve, "\u2021", "\\ddag"),
        re(ne, ie, ve, "\u2021", "\\textdaggerdbl"),
        re(ae, ie, he, "\u23b1", "\\rmoustache", !0),
        re(ae, ie, pe, "\u23b0", "\\lmoustache", !0),
        re(ae, ie, he, "\u27ef", "\\rgroup", !0),
        re(ae, ie, pe, "\u27ee", "\\lgroup", !0),
        re(ae, ie, le, "\u2213", "\\mp", !0),
        re(ae, ie, le, "\u2296", "\\ominus", !0),
        re(ae, ie, le, "\u228e", "\\uplus", !0),
        re(ae, ie, le, "\u2293", "\\sqcap", !0),
        re(ae, ie, le, "\u2217", "\\ast"),
        re(ae, ie, le, "\u2294", "\\sqcup", !0),
        re(ae, ie, le, "\u25ef", "\\bigcirc", !0),
        re(ae, ie, le, "\u2219", "\\bullet", !0),
        re(ae, ie, le, "\u2021", "\\ddagger"),
        re(ae, ie, le, "\u2240", "\\wr", !0),
        re(ae, ie, le, "\u2a3f", "\\amalg"),
        re(ae, ie, le, "&", "\\And"),
        re(ae, ie, ge, "\u27f5", "\\longleftarrow", !0),
        re(ae, ie, ge, "\u21d0", "\\Leftarrow", !0),
        re(ae, ie, ge, "\u27f8", "\\Longleftarrow", !0),
        re(ae, ie, ge, "\u27f6", "\\longrightarrow", !0),
        re(ae, ie, ge, "\u21d2", "\\Rightarrow", !0),
        re(ae, ie, ge, "\u27f9", "\\Longrightarrow", !0),
        re(ae, ie, ge, "\u2194", "\\leftrightarrow", !0),
        re(ae, ie, ge, "\u27f7", "\\longleftrightarrow", !0),
        re(ae, ie, ge, "\u21d4", "\\Leftrightarrow", !0),
        re(ae, ie, ge, "\u27fa", "\\Longleftrightarrow", !0),
        re(ae, ie, ge, "\u21a6", "\\mapsto", !0),
        re(ae, ie, ge, "\u27fc", "\\longmapsto", !0),
        re(ae, ie, ge, "\u2197", "\\nearrow", !0),
        re(ae, ie, ge, "\u21a9", "\\hookleftarrow", !0),
        re(ae, ie, ge, "\u21aa", "\\hookrightarrow", !0),
        re(ae, ie, ge, "\u2198", "\\searrow", !0),
        re(ae, ie, ge, "\u21bc", "\\leftharpoonup", !0),
        re(ae, ie, ge, "\u21c0", "\\rightharpoonup", !0),
        re(ae, ie, ge, "\u2199", "\\swarrow", !0),
        re(ae, ie, ge, "\u21bd", "\\leftharpoondown", !0),
        re(ae, ie, ge, "\u21c1", "\\rightharpoondown", !0),
        re(ae, ie, ge, "\u2196", "\\nwarrow", !0),
        re(ae, ie, ge, "\u21cc", "\\rightleftharpoons", !0),
        re(ae, oe, ge, "\u226e", "\\nless", !0),
        re(ae, oe, ge, "\ue010", "\\@nleqslant"),
        re(ae, oe, ge, "\ue011", "\\@nleqq"),
        re(ae, oe, ge, "\u2a87", "\\lneq", !0),
        re(ae, oe, ge, "\u2268", "\\lneqq", !0),
        re(ae, oe, ge, "\ue00c", "\\@lvertneqq"),
        re(ae, oe, ge, "\u22e6", "\\lnsim", !0),
        re(ae, oe, ge, "\u2a89", "\\lnapprox", !0),
        re(ae, oe, ge, "\u2280", "\\nprec", !0),
        re(ae, oe, ge, "\u22e0", "\\npreceq", !0),
        re(ae, oe, ge, "\u22e8", "\\precnsim", !0),
        re(ae, oe, ge, "\u2ab9", "\\precnapprox", !0),
        re(ae, oe, ge, "\u2241", "\\nsim", !0),
        re(ae, oe, ge, "\ue006", "\\@nshortmid"),
        re(ae, oe, ge, "\u2224", "\\nmid", !0),
        re(ae, oe, ge, "\u22ac", "\\nvdash", !0),
        re(ae, oe, ge, "\u22ad", "\\nvDash", !0),
        re(ae, oe, ge, "\u22ea", "\\ntriangleleft"),
        re(ae, oe, ge, "\u22ec", "\\ntrianglelefteq", !0),
        re(ae, oe, ge, "\u228a", "\\subsetneq", !0),
        re(ae, oe, ge, "\ue01a", "\\@varsubsetneq"),
        re(ae, oe, ge, "\u2acb", "\\subsetneqq", !0),
        re(ae, oe, ge, "\ue017", "\\@varsubsetneqq"),
        re(ae, oe, ge, "\u226f", "\\ngtr", !0),
        re(ae, oe, ge, "\ue00f", "\\@ngeqslant"),
        re(ae, oe, ge, "\ue00e", "\\@ngeqq"),
        re(ae, oe, ge, "\u2a88", "\\gneq", !0),
        re(ae, oe, ge, "\u2269", "\\gneqq", !0),
        re(ae, oe, ge, "\ue00d", "\\@gvertneqq"),
        re(ae, oe, ge, "\u22e7", "\\gnsim", !0),
        re(ae, oe, ge, "\u2a8a", "\\gnapprox", !0),
        re(ae, oe, ge, "\u2281", "\\nsucc", !0),
        re(ae, oe, ge, "\u22e1", "\\nsucceq", !0),
        re(ae, oe, ge, "\u22e9", "\\succnsim", !0),
        re(ae, oe, ge, "\u2aba", "\\succnapprox", !0),
        re(ae, oe, ge, "\u2246", "\\ncong", !0),
        re(ae, oe, ge, "\ue007", "\\@nshortparallel"),
        re(ae, oe, ge, "\u2226", "\\nparallel", !0),
        re(ae, oe, ge, "\u22af", "\\nVDash", !0),
        re(ae, oe, ge, "\u22eb", "\\ntriangleright"),
        re(ae, oe, ge, "\u22ed", "\\ntrianglerighteq", !0),
        re(ae, oe, ge, "\ue018", "\\@nsupseteqq"),
        re(ae, oe, ge, "\u228b", "\\supsetneq", !0),
        re(ae, oe, ge, "\ue01b", "\\@varsupsetneq"),
        re(ae, oe, ge, "\u2acc", "\\supsetneqq", !0),
        re(ae, oe, ge, "\ue019", "\\@varsupsetneqq"),
        re(ae, oe, ge, "\u22ae", "\\nVdash", !0),
        re(ae, oe, ge, "\u2ab5", "\\precneqq", !0),
        re(ae, oe, ge, "\u2ab6", "\\succneqq", !0),
        re(ae, oe, ge, "\ue016", "\\@nsubseteqq"),
        re(ae, oe, le, "\u22b4", "\\unlhd"),
        re(ae, oe, le, "\u22b5", "\\unrhd"),
        re(ae, oe, ge, "\u219a", "\\nleftarrow", !0),
        re(ae, oe, ge, "\u219b", "\\nrightarrow", !0),
        ...
        re(ae, oe, ge, "\u21ae", "\\nleftrightarrow", !0),
        re(ae, oe, ge, "\u21ce", "\\nLeftrightarrow", !0),
        re(ae, oe, ge, "\u25b3", "\\vartriangle"),
        re(ae, oe, ve, "\u210f", "\\hslash"),
        re(ae, oe, ve, "\u25bd", "\\triangledown"),
        re(ae, oe, ve, "\u25ca", "\\lozenge"),
        re(ae, oe, ve, "\u24c8", "\\circledS"),
        re(ae, oe, ve, "\xae", "\\circledR"),
        re(ne, oe, ve, "\xae", "\\circledR"),
        re(ae, oe, ve, "\u2221", "\\measuredangle", !0),
        re(ae, oe, ve, "\u2204", "\\nexists"),
        re(ae, oe, ve, "\u2127", "\\mho"),
        re(ae, oe, ve, "\u2132", "\\Finv", !0),
        re(ae, oe, ve, "\u2141", "\\Game", !0),
        re(ae, oe, ve, "\u2035", "\\backprime"),
        re(ae, oe, ve, "\u25b2", "\\blacktriangle"),
        re(ae, oe, ve, "\u25bc", "\\blacktriangledown"),
        re(ae, oe, ve, "\u25a0", "\\blacksquare"),
        re(ae, oe, ve, "\u29eb", "\\blacklozenge"),
        re(ae, oe, ve, "\u2605", "\\bigstar"),
        re(ae, oe, ve, "\u2222", "\\sphericalangle", !0),
        re(ae, oe, ve, "\u2201", "\\complement", !0),
        re(ae, oe, ve, "\xf0", "\\eth", !0),
        re(ne, ie, ve, "\xf0", "\xf0"),
        re(ae, oe, ve, "\u2571", "\\diagup"),
        re(ae, oe, ve, "\u2572", "\\diagdown"),
        re(ae, oe, ve, "\u25a1", "\\square"),
        re(ae, oe, ve, "\u25a1", "\\Box"),
        re(ae, oe, ve, "\u25ca", "\\Diamond"),
        re(ae, oe, ve, "\xa5", "\\yen", !0),
        re(ne, oe, ve, "\xa5", "\\yen", !0),
        re(ae, oe, ve, "\u2713", "\\checkmark", !0),
        re(ne, oe, ve, "\u2713", "\\checkmark"),
        re(ae, oe, ve, "\u2136", "\\beth", !0),
        re(ae, oe, ve, "\u2138", "\\daleth", !0),
        re(ae, oe, ve, "\u2137", "\\gimel", !0),
        re(ae, oe, ve, "\u03dd", "\\digamma", !0),
        re(ae, oe, ve, "\u03f0", "\\varkappa"),
        re(ae, oe, pe, "\u250c", "\\@ulcorner", !0),
        re(ae, oe, he, "\u2510", "\\@urcorner", !0),
        re(ae, oe, pe, "\u2514", "\\@llcorner", !0),
        re(ae, oe, he, "\u2518", "\\@lrcorner", !0),
        re(ae, oe, ge, "\u2266", "\\leqq", !0),
        re(ae, oe, ge, "\u2a7d", "\\leqslant", !0),
        re(ae, oe, ge, "\u2a95", "\\eqslantless", !0),
        re(ae, oe, ge, "\u2272", "\\lesssim", !0),
        re(ae, oe, ge, "\u2a85", "\\lessapprox", !0),
        re(ae, oe, ge, "\u224a", "\\approxeq", !0),
        re(ae, oe, le, "\u22d6", "\\lessdot"),
        re(ae, oe, ge, "\u22d8", "\\lll", !0),
        re(ae, oe, ge, "\u2276", "\\lessgtr", !0),
        re(ae, oe, ge, "\u22da", "\\lesseqgtr", !0),
        re(ae, oe, ge, "\u2a8b", "\\lesseqqgtr", !0),
        re(ae, oe, ge, "\u2251", "\\doteqdot"),
        re(ae, oe, ge, "\u2253", "\\risingdotseq", !0),
        re(ae, oe, ge, "\u2252", "\\fallingdotseq", !0),
        re(ae, oe, ge, "\u223d", "\\backsim", !0),
        re(ae, oe, ge, "\u22cd", "\\backsimeq", !0),
        re(ae, oe, ge, "\u2ac5", "\\subseteqq", !0),
        re(ae, oe, ge, "\u22d0", "\\Subset", !0),
        re(ae, oe, ge, "\u228f", "\\sqsubset", !0),
        re(ae, oe, ge, "\u227c", "\\preccurlyeq", !0),
        re(ae, oe, ge, "\u22de", "\\curlyeqprec", !0),
        re(ae, oe, ge, "\u227e", "\\precsim", !0),
        re(ae, oe, ge, "\u2ab7", "\\precapprox", !0),
        re(ae, oe, ge, "\u22b2", "\\vartriangleleft"),
        re(ae, oe, ge, "\u22b4", "\\trianglelefteq"),
        re(ae, oe, ge, "\u22a8", "\\vDash", !0),
        re(ae, oe, ge, "\u22aa", "\\Vvdash", !0),
        re(ae, oe, ge, "\u2323", "\\smallsmile"),
        re(ae, oe, ge, "\u2322", "\\smallfrown"),
        re(ae, oe, ge, "\u224f", "\\bumpeq", !0),
        re(ae, oe, ge, "\u224e", "\\Bumpeq", !0),
        re(ae, oe, ge, "\u2267", "\\geqq", !0),
        re(ae, oe, ge, "\u2a7e", "\\geqslant", !0),
        re(ae, oe, ge, "\u2a96", "\\eqslantgtr", !0),
        re(ae, oe, ge, "\u2273", "\\gtrsim", !0),
        re(ae, oe, ge, "\u2a86", "\\gtrapprox", !0),
        re(ae, oe, le, "\u22d7", "\\gtrdot"),
        re(ae, oe, ge, "\u22d9", "\\ggg", !0),
        re(ae, oe, ge, "\u2277", "\\gtrless", !0),
        re(ae, oe, ge, "\u22db", "\\gtreqless", !0),
        re(ae, oe, ge, "\u2a8c", "\\gtreqqless", !0),
        re(ae, oe, ge, "\u2256", "\\eqcirc", !0),
        re(ae, oe, ge, "\u2257", "\\circeq", !0),
        re(ae, oe, ge, "\u225c", "\\triangleq", !0),
        re(ae, oe, ge, "\u223c", "\\thicksim"),
        re(ae, oe, ge, "\u2248", "\\thickapprox"),
        re(ae, oe, ge, "\u2ac6", "\\supseteqq", !0),
        re(ae, oe, ge, "\u22d1", "\\Supset", !0),
        re(ae, oe, ge, "\u2290", "\\sqsupset", !0),
        re(ae, oe, ge, "\u227d", "\\succcurlyeq", !0),
        re(ae, oe, ge, "\u22df", "\\curlyeqsucc", !0),
        re(ae, oe, ge, "\u227f", "\\succsim", !0),
        re(ae, oe, ge, "\u2ab8", "\\succapprox", !0),
        re(ae, oe, ge, "\u22b3", "\\vartriangleright"),
        re(ae, oe, ge, "\u22b5", "\\trianglerighteq"),
        re(ae, oe, ge, "\u22a9", "\\Vdash", !0),
        re(ae, oe, ge, "\u2223", "\\shortmid"),
        re(ae, oe, ge, "\u2225", "\\shortparallel"),
        re(ae, oe, ge, "\u226c", "\\between", !0),
        re(ae, oe, ge, "\u22d4", "\\pitchfork", !0),
        re(ae, oe, ge, "\u221d", "\\varpropto"),
        re(ae, oe, ge, "\u25c0", "\\blacktriangleleft"),
        re(ae, oe, ge, "\u2234", "\\therefore", !0),
        re(ae, oe, ge, "\u220d", "\\backepsilon"),
        re(ae, oe, ge, "\u25b6", "\\blacktriangleright"),
        re(ae, oe, ge, "\u2235", "\\because", !0),
        re(ae, oe, ge, "\u22d8", "\\llless"),
        re(ae, oe, ge, "\u22d9", "\\gggtr"),
        re(ae, oe, le, "\u22b2", "\\lhd"),
        re(ae, oe, le, "\u22b3", "\\rhd"),
        ...
        re(ae, ie, ge, "\u22c8", "\\Join"),
        re(ae, oe, ge, "\u2251", "\\Doteq", !0),
        re(ae, oe, le, "\u2214", "\\dotplus", !0),
        re(ae, oe, le, "\u2216", "\\smallsetminus"),
        re(ae, oe, le, "\u22d2", "\\Cap", !0),
        re(ae, oe, le, "\u22d3", "\\Cup", !0),
        re(ae, oe, le, "\u2a5e", "\\doublebarwedge", !0),
        re(ae, oe, le, "\u229f", "\\boxminus", !0),
        re(ae, oe, le, "\u229e", "\\boxplus", !0),
        re(ae, oe, le, "\u22c7", "\\divideontimes", !0),
        re(ae, oe, le, "\u22c9", "\\ltimes", !0),
        re(ae, oe, le, "\u22ca", "\\rtimes", !0),
        re(ae, oe, le, "\u22cb", "\\leftthreetimes", !0),
        re(ae, oe, le, "\u22cc", "\\rightthreetimes", !0),
        re(ae, oe, le, "\u22cf", "\\curlywedge", !0),
        re(ae, oe, le, "\u22ce", "\\curlyvee", !0),
        re(ae, oe, le, "\u229d", "\\circleddash", !0),
        re(ae, oe, le, "\u229b", "\\circledast", !0),
        re(ae, oe, le, "\u22c5", "\\centerdot"),
        re(ae, oe, le, "\u22ba", "\\intercal", !0),
        re(ae, oe, le, "\u22d2", "\\doublecap"),
        re(ae, oe, le, "\u22d3", "\\doublecup"),
        re(ae, oe, le, "\u22a0", "\\boxtimes", !0),
        re(ae, oe, ge, "\u21e2", "\\dashrightarrow", !0),
        re(ae, oe, ge, "\u21e0", "\\dashleftarrow", !0),
        re(ae, oe, ge, "\u21c7", "\\leftleftarrows", !0),
        re(ae, oe, ge, "\u21c6", "\\leftrightarrows", !0),
        re(ae, oe, ge, "\u21da", "\\Lleftarrow", !0),
        re(ae, oe, ge, "\u219e", "\\twoheadleftarrow", !0),
        re(ae, oe, ge, "\u21a2", "\\leftarrowtail", !0),
        re(ae, oe, ge, "\u21ab", "\\looparrowleft", !0),
        re(ae, oe, ge, "\u21cb", "\\leftrightharpoons", !0),
        re(ae, oe, ge, "\u21b6", "\\curvearrowleft", !0),
        re(ae, oe, ge, "\u21ba", "\\circlearrowleft", !0),
        re(ae, oe, ge, "\u21b0", "\\Lsh", !0),
        re(ae, oe, ge, "\u21c8", "\\upuparrows", !0),
        re(ae, oe, ge, "\u21bf", "\\upharpoonleft", !0),
        re(ae, oe, ge, "\u21c3", "\\downharpoonleft", !0),
        re(ae, ie, ge, "\u22b6", "\\origof", !0),
        re(ae, ie, ge, "\u22b7", "\\imageof", !0),
        re(ae, oe, ge, "\u22b8", "\\multimap", !0),
        re(ae, oe, ge, "\u21ad", "\\leftrightsquigarrow", !0),
        re(ae, oe, ge, "\u21c9", "\\rightrightarrows", !0),
        re(ae, oe, ge, "\u21c4", "\\rightleftarrows", !0),
        re(ae, oe, ge, "\u21a0", "\\twoheadrightarrow", !0),
        re(ae, oe, ge, "\u21a3", "\\rightarrowtail", !0),
        re(ae, oe, ge, "\u21ac", "\\looparrowright", !0),
        re(ae, oe, ge, "\u21b7", "\\curvearrowright", !0),
        re(ae, oe, ge, "\u21bb", "\\circlearrowright", !0),
        re(ae, oe, ge, "\u21b1", "\\Rsh", !0),
        re(ae, oe, ge, "\u21ca", "\\downdownarrows", !0),
        re(ae, oe, ge, "\u21be", "\\upharpoonright", !0),
        re(ae, oe, ge, "\u21c2", "\\downharpoonright", !0),
        re(ae, oe, ge, "\u21dd", "\\rightsquigarrow", !0),
        re(ae, oe, ge, "\u21dd", "\\leadsto"),
        re(ae, oe, ge, "\u21db", "\\Rrightarrow", !0),
        re(ae, oe, ge, "\u21be", "\\restriction"),
        re(ae, ie, ve, "\u2018", "`"),
        re(ae, ie, ve, "$", "\\$"),
        re(ne, ie, ve, "$", "\\$"),
        re(ne, ie, ve, "$", "\\textdollar"),
        re(ae, ie, ve, "%", "\\%"),
        re(ne, ie, ve, "%", "\\%"),
        re(ae, ie, ve, "_", "\\_"),
        re(ne, ie, ve, "_", "\\_"),
        re(ne, ie, ve, "_", "\\textunderscore"),
        re(ae, ie, ve, "\u2220", "\\angle", !0),
        re(ae, ie, ve, "\u221e", "\\infty", !0),
        re(ae, ie, ve, "\u2032", "\\prime"),
        re(ae, ie, ve, "\u25b3", "\\triangle"),
        re(ae, ie, ve, "\u0393", "\\Gamma", !0),
        re(ae, ie, ve, "\u0394", "\\Delta", !0),
        re(ae, ie, ve, "\u0398", "\\Theta", !0),
        re(ae, ie, ve, "\u039b", "\\Lambda", !0),
        re(ae, ie, ve, "\u039e", "\\Xi", !0),
        re(ae, ie, ve, "\u03a0", "\\Pi", !0),
        re(ae, ie, ve, "\u03a3", "\\Sigma", !0),
        re(ae, ie, ve, "\u03a5", "\\Upsilon", !0),
        re(ae, ie, ve, "\u03a6", "\\Phi", !0),
        re(ae, ie, ve, "\u03a8", "\\Psi", !0),
        re(ae, ie, ve, "\u03a9", "\\Omega", !0),
        re(ae, ie, ve, "A", "\u0391"),
        re(ae, ie, ve, "B", "\u0392"),
        re(ae, ie, ve, "E", "\u0395"),
        re(ae, ie, ve, "Z", "\u0396"),
        ...
        re(ae, ie, ve, "X", "\u03a7"),
        re(ae, ie, ve, "\xac", "\\neg", !0),
        re(ae, ie, ve, "\xac", "\\lnot"),
        re(ae, ie, ve, "\u22a4", "\\top"),
        re(ae, ie, ve, "\u22a5", "\\bot"),
        re(ae, ie, ve, "\u2205", "\\emptyset"),
        re(ae, oe, ve, "\u2205", "\\varnothing"),
        re(ae, ie, ce, "\u03b1", "\\alpha", !0),
        re(ae, ie, ce, "\u03b2", "\\beta", !0),
        re(ae, ie, ce, "\u03b3", "\\gamma", !0),
        re(ae, ie, ce, "\u03b4", "\\delta", !0),
        re(ae, ie, ce, "\u03f5", "\\epsilon", !0),
        re(ae, ie, ce, "\u03b6", "\\zeta", !0),
        re(ae, ie, ce, "\u03b7", "\\eta", !0),
        re(ae, ie, ce, "\u03b8", "\\theta", !0),
        re(ae, ie, ce, "\u03b9", "\\iota", !0),
        re(ae, ie, ce, "\u03ba", "\\kappa", !0),
        re(ae, ie, ce, "\u03bb", "\\lambda", !0),
        re(ae, ie, ce, "\u03bc", "\\mu", !0),
        re(ae, ie, ce, "\u03bd", "\\nu", !0),
        re(ae, ie, ce, "\u03be", "\\xi", !0),
        re(ae, ie, ce, "\u03bf", "\\omicron", !0),
        re(ae, ie, ce, "\u03c0", "\\pi", !0),
        re(ae, ie, ce, "\u03c1", "\\rho", !0),
        re(ae, ie, ce, "\u03c3", "\\sigma", !0),
        re(ae, ie, ce, "\u03c4", "\\tau", !0),
        re(ae, ie, ce, "\u03c5", "\\upsilon", !0),
        re(ae, ie, ce, "\u03d5", "\\phi", !0),
        re(ae, ie, ce, "\u03c7", "\\chi", !0),
        re(ae, ie, ce, "\u03c8", "\\psi", !0),
        re(ae, ie, ce, "\u03c9", "\\omega", !0),
        re(ae, ie, ce, "\u03b5", "\\varepsilon", !0),
        re(ae, ie, ce, "\u03d1", "\\vartheta", !0),
        re(ae, ie, ce, "\u03d6", "\\varpi", !0),
        re(ae, ie, ce, "\u03f1", "\\varrho", !0),
        re(ae, ie, ce, "\u03c2", "\\varsigma", !0),
        re(ae, ie, ce, "\u03c6", "\\varphi", !0),
        re(ae, ie, le, "\u2217", "*", !0),
        re(ae, ie, le, "+", "+"),
        re(ae, ie, le, "\u2212", "-", !0),
        re(ae, ie, le, "\u22c5", "\\cdot", !0),
        re(ae, ie, le, "\u2218", "\\circ", !0),
        re(ae, ie, le, "\xf7", "\\div", !0),
        re(ae, ie, le, "\xb1", "\\pm", !0),
        re(ae, ie, le, "\xd7", "\\times", !0),
        re(ae, ie, le, "\u2229", "\\cap", !0),
        re(ae, ie, le, "\u222a", "\\cup", !0),
        re(ae, ie, le, "\u2216", "\\setminus", !0),
        re(ae, ie, le, "\u2227", "\\land"),
        re(ae, ie, le, "\u2228", "\\lor"),
        re(ae, ie, le, "\u2227", "\\wedge", !0),
        re(ae, ie, le, "\u2228", "\\vee", !0),
        re(ae, ie, ve, "\u221a", "\\surd"),
        re(ae, ie, pe, "\u27e8", "\\langle", !0),
        re(ae, ie, pe, "\u2223", "\\lvert"),
        re(ae, ie, pe, "\u2225", "\\lVert"),
        re(ae, ie, he, "?", "?"),
        re(ae, ie, he, "!", "!"),
        re(ae, ie, he, "\u27e9", "\\rangle", !0),
        re(ae, ie, he, "\u2223", "\\rvert"),
        re(ae, ie, he, "\u2225", "\\rVert"),
        re(ae, ie, ge, "=", "="),
        re(ae, ie, ge, ":", ":"),
        re(ae, ie, ge, "\u2248", "\\approx", !0),
        re(ae, ie, ge, "\u2245", "\\cong", !0),
        re(ae, ie, ge, "\u2265", "\\ge"),
        re(ae, ie, ge, "\u2265", "\\geq", !0),
        re(ae, ie, ge, "\u2190", "\\gets"),
        ...
        re(ae, ie, ge, "\u2208", "\\in", !0),
        re(ae, ie, ge, "\ue020", "\\@not"),
        re(ae, ie, ge, "\u2282", "\\subset", !0),
        re(ae, ie, ge, "\u2283", "\\supset", !0),
        re(ae, ie, ge, "\u2286", "\\subseteq", !0),
        re(ae, ie, ge, "\u2287", "\\supseteq", !0),
        re(ae, oe, ge, "\u2288", "\\nsubseteq", !0),
        re(ae, oe, ge, "\u2289", "\\nsupseteq", !0),
        re(ae, ie, ge, "\u22a8", "\\models"),
        re(ae, ie, ge, "\u2190", "\\leftarrow", !0),
        ...
        re(ae, oe, ge, "\u2270", "\\nleq", !0),
        re(ae, ie, fe, "\xa0", "\\ "),
        re(ae, ie, fe, "\xa0", "\\space"),
        re(ae, ie, fe, "\xa0", "\\nobreakspace"),
        re(ne, ie, fe, "\xa0", "\\ "),
        re(ne, ie, fe, "\xa0", " "),
        re(ne, ie, fe, "\xa0", "\\space"),
        re(ne, ie, fe, "\xa0", "\\nobreakspace"),
        re(ae, ie, fe, null, "\\nobreak"),
        re(ae, ie, fe, null, "\\allowbreak"),
        re(ae, ie, de, ",", ","),
        re(ae, ie, de, ";", ";"),
        re(ae, oe, le, "\u22bc", "\\barwedge", !0),
        re(ae, oe, le, "\u22bb", "\\veebar", !0),
        re(ae, ie, le, "\u2299", "\\odot", !0),
        re(ae, ie, le, "\u2295", "\\oplus", !0),
        re(ae, ie, le, "\u2297", "\\otimes", !0),
        re(ae, ie, ve, "\u2202", "\\partial", !0),
        re(ae, ie, le, "\u2298", "\\oslash", !0),
        re(ae, oe, le, "\u229a", "\\circledcirc", !0),
        re(ae, oe, le, "\u22a1", "\\boxdot", !0),
        re(ae, ie, le, "\u25b3", "\\bigtriangleup"),
        re(ae, ie, le, "\u25bd", "\\bigtriangledown"),
        re(ae, ie, le, "\u2020", "\\dagger"),
        re(ae, ie, le, "\u22c4", "\\diamond"),
        re(ae, ie, le, "\u22c6", "\\star"),
        re(ae, ie, le, "\u25c3", "\\triangleleft"),
        re(ae, ie, le, "\u25b9", "\\triangleright"),
        re(ae, ie, pe, "{", "\\{"),
        re(ne, ie, ve, "{", "\\{"),
        re(ne, ie, ve, "{", "\\textbraceleft"),
        re(ae, ie, he, "}", "\\}"),
        re(ne, ie, ve, "}", "\\}"),
        re(ne, ie, ve, "}", "\\textbraceright"),
        re(ae, ie, pe, "{", "\\lbrace"),
        re(ae, ie, he, "}", "\\rbrace"),
        re(ae, ie, pe, "[", "\\lbrack", !0),
        re(ne, ie, ve, "[", "\\lbrack", !0),
        re(ae, ie, he, "]", "\\rbrack", !0),
        re(ne, ie, ve, "]", "\\rbrack", !0),
        re(ae, ie, pe, "(", "\\lparen", !0),
        re(ae, ie, he, ")", "\\rparen", !0),
        re(ne, ie, ve, "<", "\\textless", !0),
        re(ne, ie, ve, ">", "\\textgreater", !0),
        re(ae, ie, pe, "\u230a", "\\lfloor", !0),
        re(ae, ie, he, "\u230b", "\\rfloor", !0),
        re(ae, ie, pe, "\u2308", "\\lceil", !0),
        re(ae, ie, he, "\u2309", "\\rceil", !0),
        re(ae, ie, ve, "\\", "\\backslash"),
        re(ae, ie, ve, "\u2223", "|"),
        re(ae, ie, ve, "\u2223", "\\vert"),
        re(ne, ie, ve, "|", "\\textbar", !0),
        re(ae, ie, ve, "\u2225", "\\|"),
        re(ae, ie, ve, "\u2225", "\\Vert"),
        re(ne, ie, ve, "\u2225", "\\textbardbl"),
        re(ne, ie, ve, "~", "\\textasciitilde"),
        re(ne, ie, ve, "\\", "\\textbackslash"),
        re(ne, ie, ve, "^", "\\textasciicircum"),
        re(ae, ie, ge, "\u2191", "\\uparrow", !0),
        re(ae, ie, ge, "\u21d1", "\\Uparrow", !0),
        re(ae, ie, ge, "\u2193", "\\downarrow", !0),
        re(ae, ie, ge, "\u21d3", "\\Downarrow", !0),
        re(ae, ie, ge, "\u2195", "\\updownarrow", !0),
        re(ae, ie, ge, "\u21d5", "\\Updownarrow", !0),
        re(ae, ie, ue, "\u2210", "\\coprod"),
        re(ae, ie, ue, "\u22c1", "\\bigvee"),
        re(ae, ie, ue, "\u22c0", "\\bigwedge"),
        re(ae, ie, ue, "\u2a04", "\\biguplus"),
        re(ae, ie, ue, "\u22c2", "\\bigcap"),
        re(ae, ie, ue, "\u22c3", "\\bigcup"),
        re(ae, ie, ue, "\u222b", "\\int"),
        re(ae, ie, ue, "\u222b", "\\intop"),
        ...
        re(ae, ie, ue, "\u220f", "\\prod"),
        re(ae, ie, ue, "\u2211", "\\sum"),
        re(ae, ie, ue, "\u2a02", "\\bigotimes"),
        re(ae, ie, ue, "\u2a01", "\\bigoplus"),
        re(ae, ie, ue, "\u2a00", "\\bigodot"),
        re(ae, ie, ue, "\u222e", "\\oint"),
        re(ae, ie, ue, "\u222f", "\\oiint"),
        re(ae, ie, ue, "\u2230", "\\oiiint"),
        re(ae, ie, ue, "\u2a06", "\\bigsqcup"),
        re(ae, ie, ue, "\u222b", "\\smallint"),
        re(ne, ie, me, "\u2026", "\\textellipsis"),
        re(ae, ie, me, "\u2026", "\\mathellipsis"),
        re(ne, ie, me, "\u2026", "\\ldots", !0),
        re(ae, ie, me, "\u2026", "\\ldots", !0),
        re(ae, ie, me, "\u22ef", "\\@cdots", !0),
        re(ae, ie, me, "\u22f1", "\\ddots", !0),
        re(ae, ie, ve, "\u22ee", "\\varvdots"),
        re(ne, ie, ve, "\u22ee", "\\varvdots"),
        re(ae, ie, se, "\u02ca", "\\acute"),
        re(ae, ie, se, "\u02cb", "\\grave"),
        re(ae, ie, se, "\xa8", "\\ddot"),
        re(ae, ie, se, "~", "\\tilde"),
        re(ae, ie, se, "\u02c9", "\\bar"),
        re(ae, ie, se, "\u02d8", "\\breve"),
        re(ae, ie, se, "\u02c7", "\\check"),
        ...
        re(ne, ie, ve, "\u0131", "\\i", !0),
        re(ne, ie, ve, "\u0237", "\\j", !0),
        re(ne, ie, ve, "\xdf", "\\ss", !0),
        re(ne, ie, ve, "\xe6", "\\ae", !0),
        re(ne, ie, ve, "\u0153", "\\oe", !0),
        re(ne, ie, ve, "\xf8", "\\o", !0),
        re(ne, ie, ve, "\xc6", "\\AE", !0),
        re(ne, ie, ve, "\u0152", "\\OE", !0),
        re(ne, ie, ve, "\xd8", "\\O", !0),
        re(ne, ie, se, "\u02ca", "\\'"),
        re(ne, ie, se, "\u02cb", "\\`"),
        ...
        re(ne, ie, se, "\xa8", '\\"'),
        re(ne, ie, se, "\u02dd", "\\H"),
        re(ne, ie, se, "\u25ef", "\\textcircled"));
      var be = { "--": !0, "---": !0, "``": !0, "''": !0 };
      (re(ne, ie, ve, "\u2013", "--", !0),
        re(ne, ie, ve, "\u2013", "\\textendash"),
        re(ne, ie, ve, "\u2014", "---", !0),
        re(ne, ie, ve, "\u2014", "\\textemdash"),
        re(ne, ie, ve, "\u2018", "`", !0),
        re(ne, ie, ve, "\u2018", "\\textquoteleft"),
        re(ne, ie, ve, "\u2019", "'", !0),
        re(ne, ie, ve, "\u2019", "\\textquoteright"),
        re(ne, ie, ve, "\u201c", "``", !0),
        re(ne, ie, ve, "\u201c", "\\textquotedblleft"),
        re(ne, ie, ve, "\u201d", "''", !0),
        re(ne, ie, ve, "\u201d", "\\textquotedblright"),
        re(ae, ie, ve, "\xb0", "\\degree", !0),
        re(ne, ie, ve, "\xb0", "\\degree"),
        re(ne, ie, ve, "\xb0", "\\textdegree", !0),
        re(ae, ie, ve, "\xa3", "\\pounds"),
        re(ae, ie, ve, "\xa3", "\\mathsterling", !0),
        re(ne, ie, ve, "\xa3", "\\pounds"),
        re(ne, ie, ve, "\xa3", "\\textsterling", !0),
        re(ae, oe, ve, "\u2720", "\\maltese"),
        re(ne, oe, ve, "\u2720", "\\maltese"));
      for (var ye = '0123456789/@."', xe = 0; xe < 14; xe++) {
        var we = ye.charAt(xe);
        re(ae, ie, ve, we, we);
      }
      for (var ke = '0123456789!@*()-=+";:?/.,', ze = 0; ze < 25; ze++) {
        var Se = ke.charAt(ze);
        re(ne, ie, ve, Se, Se);
      }
      for (
        var Me = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", Ae = 0;
        Ae < 52;
        Ae++
      ) {
        var Te = Me.charAt(Ae);
      ...
      (re(ae, oe, ve, "C", "\u2102"),
        ...
        re(ae, ie, ce, "h", "\u210e"),
        re(ne, ie, ce, "h", "\u210e"));
      for (var Be = "", qe = 0; qe < 52; qe++) {
        var Ce = Me.charAt(qe);
        (re(ae, ie, ce, Ce, (Be = String.fromCharCode(55349, 56320 + qe))),
          re(ne, ie, ve, Ce, Be),
          re(ae, ie, ce, Ce, (Be = String.fromCharCode(55349, 56372 + qe))),
          re(ne, ie, ve, Ce, Be),
          re(ae, ie, ce, Ce, (Be = String.fromCharCode(55349, 56424 + qe))),
          re(ne, ie, ve, Ce, Be),
          re(ae, ie, ce, Ce, (Be = String.fromCharCode(55349, 56580 + qe))),
          re(ne, ie, ve, Ce, Be),
          re(ae, ie, ce, Ce, (Be = String.fromCharCode(55349, 56684 + qe))),
          re(ne, ie, ve, Ce, Be),
          re(ae, ie, ce, Ce, (Be = String.fromCharCode(55349, 56736 + qe))),
          re(ne, ie, ve, Ce, Be),
          re(ae, ie, ce, Ce, (Be = String.fromCharCode(55349, 56788 + qe))),
          re(ne, ie, ve, Ce, Be),
          re(ae, ie, ce, Ce, (Be = String.fromCharCode(55349, 56840 + qe))),
          re(ne, ie, ve, Ce, Be),
          re(ae, ie, ce, Ce, (Be = String.fromCharCode(55349, 56944 + qe))),
          re(ne, ie, ve, Ce, Be),
          qe < 26 &&
            (re(ae, ie, ce, Ce, (Be = String.fromCharCode(55349, 56632 + qe))),
            re(ne, ie, ve, Ce, Be),
            re(ae, ie, ce, Ce, (Be = String.fromCharCode(55349, 56476 + qe))),
            re(ne, ie, ve, Ce, Be)));
      }
      (re(ae, ie, ce, "k", (Be = String.fromCharCode(55349, 56668))),
        re(ne, ie, ve, "k", Be));
      for (var Ie = 0; Ie < 10; Ie++) {
        var He = Ie.toString();
        (re(ae, ie, ce, He, (Be = String.fromCharCode(55349, 57294 + Ie))),
          re(ne, ie, ve, He, Be),
          re(ae, ie, ce, He, (Be = String.fromCharCode(55349, 57314 + Ie))),
          re(ne, ie, ve, He, Be),
          re(ae, ie, ce, He, (Be = String.fromCharCode(55349, 57324 + Ie))),
          re(ne, ie, ve, He, Be),
          re(ae, ie, ce, He, (Be = String.fromCharCode(55349, 57334 + Ie))),
          re(ne, ie, ve, He, Be));
      }
      for (var Re = "\xd0\xde\xfe", Ee = 0; Ee < 3; Ee++) {
        var Ne = Re.charAt(Ee);
        (re(ae, ie, ce, Ne, Ne), re(ne, ie, ve, Ne, Ne));
      }
      var Oe = [
        ...
        Pe = function (e, t, r, a, n) {
          ...
          if (((e = o.value), s)) {
            ...
            (("text" === r || (a && "mathit" === a.font)) && (l = 0),
              (i = new Y(e, s.height, s.depth, l, s.skew, s.width, n)));
          } else
            ("undefined" != typeof console &&
              console.warn(
        ...
        Ve = function (e, t, r, a) {
          return (
            void 0 === a && (a = []),
            "boldsymbol" === r.font && Le(e, "Main-Bold", t).metrics
        ...
        Fe = function (e, t, r) {
          ...
          if (l) {
            ...
            if ("boldsymbol" === l) {
              ...
              s
                ? ((c = Qe[l].fontName), (u = [l]))
                : ((c = Je(l, t.fontWeight, t.fontShape)),
                  (u = [l, t.fontWeight, t.fontShape]));
            if (Le(i, c, n).metrics) return Pe(i, c, n, t, o.concat(u));
            if (be.hasOwnProperty(i) && "Typewriter" === c.slice(0, 10)) {
              for (var d = [], g = 0; g < i.length; g++)
                d.push(Pe(i[g], c, n, t, o.concat(u)));
              return _e(d);
            }
          }
          if ("mathord" === r)
            return Pe(i, "Math-Italic", n, t, o.concat(["mathnormal"]));
          if ("textord" === r) {
            var f = te[n][i] && te[n][i].font;
            if ("ams" === f) {
        ...
        Ge = (e, t) => {
          ...
          for (var a of Object.keys(e.style))
            if (e.style[a] !== t.style[a]) return !1;
          for (var n of Object.keys(t.style))
            if (e.style[n] !== t.style[n]) return !1;
          return !0;
        },
        Ue = (e) => {
        ...
        $e = function (e, t) {
          return e instanceof q ? We([], [e], t) : e;
        },
        Ze = function (e, t) {
          for (
          ...
          var l = We(["pstrut"], []);
          l.style.height = E(n);
          for (var h = [], m = a, c = a, u = a, p = 0; p < r.length; p++) {
            var d = r[p];
            if ("kern" === d.type) u += d.size;
            else {
              var g = d.elem,
                f = d.wrapperClasses || [],
                v = d.wrapperStyle || {},
                b = We(f, [l, g], void 0, v);
              ((b.style.top = E(-n - u - g.depth)),
                d.marginLeft && (b.style.marginLeft = d.marginLeft),
                d.marginRight && (b.style.marginRight = d.marginRight),
                h.push(b),
                (u += g.height + g.depth));
            }
            ((m = Math.min(m, u)), (c = Math.max(c, u)));
          }
          var y,
            x = We(["vlist"], h);
          if (((x.style.height = E(c)), m < 0)) {
            var w = We([], []),
              k = We(["vlist"], [w]);
            k.style.height = E(-m);
            var z = We(["vlist-s"], [new Y("\u200b")]);
            y = [We(["vlist-r"], [x, z]), We(["vlist-r"], [k])];
          } else y = [We(["vlist-r"], [x])];
          var S = We(["vlist-t"], y);
          return (
            2 === y.length && S.classes.push("vlist-t2"),
            (S.height = c),
            (S.depth = -m),
            S
          );
        ...
        Ke = (e, t) => {
          var r = We(["mspace"], [], t),
            a = R(e, t);
          return ((r.style.marginRight = E(a)), r);
        },
        Je = function (e, t, r) {
          var a = "";
          switch (e) {
        ...
        nt = { number: 5, unit: "mu" },
        it = {
          mord: { mop: rt, mbin: at, mrel: nt, minner: rt },
          mop: { mord: rt, mop: rt, mrel: nt, minner: rt },
          mbin: { mord: at, mop: at, mopen: at, minner: at },
          mrel: { mord: nt, mop: nt, mopen: nt, minner: nt },
          mopen: {},
          mclose: { mop: rt, mbin: at, mrel: nt, minner: rt },
          mpunct: {
            mord: rt,
            mop: rt,
            mrel: nt,
      ...
      var ut = function (e) {
        ...
        dt = new Set(["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"]),
        gt = new Set(["rightmost", "mrel", "mclose", "mpunct"]),
        ft = {
          display: z.DISPLAY,
          text: z.TEXT,
          script: z.SCRIPT,
        ...
        bt = function (e, t, r, a) {
          ...
          if (1 === e.length) {
            ...
            "sizing" === h.type
              ...
              : "styling" === h.type && (l = t.havingStyle(ft[h.style]));
          }
          var m = We([a[0] || "leftmost"], [], t),
            c = We([a[1] || "rightmost"], [], t),
            u = "root" === r;
          return (
            yt(
              n,
              (e, t) => {
                ...
                "mbin" === r && gt.has(a)
                  ? (t.classes[0] = "mord")
                  : "mbin" === a && dt.has(r) && (e.classes[0] = "mord");
              },
              { node: m },
              c,
              u,
        ...
        yt = function (e, t, r, a, n) {
          a && e.push(a);
          for (var i = 0; i < e.length; i++) {
            var o = e[i],
              s = xt(o);
            if (s) yt(s.children, t, r, null, n);
            else {
              ...
              (l
                ? (r.node = o)
                : n && o.hasClass("newline") && (r.node = We(["leftmost"])),
                (r.insertAfter = ((t) => (r) => {
                  (e.splice(t + 1, 0, r), i++);
                })(i)));
            }
        ...
        wt = function (e, t) {
          ...
          if (r) {
            var a = r.children;
            if (a.length) {
              if ("right" === t) return wt(a[a.length - 1], "right");
              if ("left" === t) return wt(a[0], "left");
            }
          }
          return e;
        },
      ...
      function Mt(e, t) {
        var r = We(["base"], e, t),
          a = We(["strut"]);
        return (
          (a.style.height = E(r.height + r.depth)),
          r.depth && (a.style.verticalAlign = E(-r.depth)),
        ...
        for (var i, o = [], s = [], l = 0; l < n.length; l++)
          if (
            ...
            n[l].hasClass("newline") &&
              (s.pop(),
              s.length > 0 && (o.push(Mt(s, t)), (s = [])),
              o.push(n[l]));
        (s.length > 0 && o.push(Mt(s, t)),
          r
            ? (((i = Mt(bt(r, t, !0), t)).classes = ["tag"]), o.push(i))
            : a && o.push(a));
        var m = We(["katex-html"], o);
        if ((m.setAttribute("aria-hidden", "true"), i)) {
          var c = i.children[0];
          ((c.style.height = E(m.height + m.depth)),
            m.depth && (c.style.verticalAlign = E(-m.depth)));
        }
        return m;
      }
      function Tt(e) {
      ...
      class Bt {
        ...
        toNode() {
          ...
          for (var r = 0; r < this.children.length; r++)
            if (
              this.children[r] instanceof qt &&
              this.children[r + 1] instanceof qt
            ) {
              for (
        ...
        toMarkup() {
          ...
          for (var t in this.attributes)
            Object.prototype.hasOwnProperty.call(this.attributes, t) &&
              ((e += " " + t + '="'), (e += l(this.attributes[t])), (e += '"'));
          (this.classes.length > 0 &&
            (e += ' class ="' + l(N(this.classes)) + '"'),
            (e += ">"));
          for (var r = 0; r < this.children.length; r++)
            e += this.children[r].toMarkup();
          return (e += "</" + this.type + ">");
      ...
      var It = new Set(["\\imath", "\\jmath"]),
        ...
        Nt = function (e, t) {
          ...
          var n = e.text;
          if (It.has(n)) return null;
          if (te[a][n]) {
            var i = te[a][n].replace;
            i && (n = i);
          }
          return K(n, Qe[r].fontName, a) ? Qe[r].variant : null;
        };
      function Ot(e) {
        if (!e) return !1;
      ...
      var Dt = function (e, t, r) {
          ...
          for (var n, i = [], o = 0; o < e.length; o++) {
            var s = Pt(e[o], t);
            if (s instanceof Bt && n instanceof Bt) {
              if (
                "mtext" === s.type &&
                "mtext" === n.type &&
      ...
      function Vt(e, t, r, a, n) {
        var i,
          o = Dt(e, r);
        i =
          1 === o.length && o[0] instanceof Bt && Ht.has(o[0].type)
            ? o[0]
            : new Bt("mrow", o);
        var s = new Bt("annotation", [new qt(t)]);
        s.setAttribute("encoding", "application/x-tex");
        var l = new Bt("semantics", [i, s]),
          h = new Bt("math", [l]);
        return (
          h.setAttribute("xmlns", "http://www.w3.org/1998/Math/MathML"),
          a && h.setAttribute("display", "block"),
          We([n ? "katex" : "katex-mathml"], [h])
        );
      }
      var Ft = [
          [1, 1, 1],
        ...
        Ut = function (e, t) {
          return t.size < 2 ? e : Ft[e - 1][t.size - 1];
        };
      class Yt {
        constructor(e) {
          ((this.style = e.style),
            (this.color = e.color),
            (this.size = e.size || Yt.BASESIZE),
        ...
        extend(e) {
          ...
          return (Object.assign(t, e), new Yt(t));
        }
        havingStyle(e) {
          return this.style === e
            ? this
        ...
        havingBaseStyle(e) {
          e = e || this.style.text();
          var t = Ut(Yt.BASESIZE, e);
          return this.size === t &&
            this.textSize === Yt.BASESIZE &&
            this.style === e
            ? this
        ...
        baseSizingClasses() {
          return this.size !== Yt.BASESIZE
            ? ["sizing", "reset-size" + this.size, "size" + Yt.BASESIZE]
            : [];
        }
        fontMetrics() {
          return (
            this._fontMetrics ||
              (this._fontMetrics = (function (e) {
                var t;
                if (!J[(t = e >= 5 ? 0 : e >= 3 ? 1 : 2)]) {
                  var r = (J[t] = { cssEmPerMu: $.quad[t] / 18 });
      ...
      var Wt = function (e) {
        ...
        _t = function (e) {
          var t = new Bt("mo", [new qt(jt[e.replace(/^\\/, "")])]);
        ...
        Zt = new Set(["widehat", "widecheck", "widetilde", "utilde"]),
        Kt = function (e, t) {
          var {
            span: r,
            minWidth: a,
            ...
            if (Zt.has(a)) {
              var n,
                ...
                o,
                s = e,
                l = "ordgroup" === s.base.type ? s.base.body.length : 1;
              if (l > 5)
              ...
              return { span: Xe([], [c], t), minWidth: 0, height: o };
            }
            var u,
              p,
              d = [],
            ...
            for (var w = 0; w < x; w++) {
              ...
              ((S.style.height = E(y)), d.push(S));
            }
            return { span: We(["stretchy"], d, t), minWidth: v, height: y };
          })();
          return (
            (r.height = n),
            (r.style.height = E(n)),
            a > 0 && (r.style.minWidth = E(a)),
            r
          );
        };
      function Jt(e, t) {
      ...
      var tr = (e) => {
        ...
        rr = (e, t) => {
          ...
          e && "supsub" === e.type
            ? ((r = (a = Jt(e.base, "accent")).base),
              ...
              (e.base = a))
            : (r = (a = Jt(e, "accent")).base);
          var i,
            o,
            s = St(r, t.havingCrampedStyle()),
            l = 0;
          a.isShifty &&
            c(r) &&
            (l = null != (i = null == (o = tr(s)) ? void 0 : o.skew) ? i : 0);
          var h,
            m = "\\c" === a.label,
            u = m
              ? s.height + s.depth
          ...
          if (a.isStretchy)
            ...
            ("\\vec" === a.label
              ...
              : ((p = (function (e) {
                  ...
                  (p = Fe(
                    { type: "textord", mode: a.mode, text: a.label },
                    t,
                    "textord",
                  )),
                )),
            ...
            g && (h.classes.push("accent-full"), (u = s.height));
            var f = l;
            (g || (f -= d / 2),
              (h.style.left = E(f)),
        ...
        ar = (e, t) => {
          var r = e.isStretchy
              ? _t(e.label)
              : new Bt("mo", [Rt(e.label, e.mode)]),
            a = new Bt("mover", [Pt(e.base, t), r]);
      ...
      (mt({
        ...
        mt({
          ...
          htmlBuilder: (e, t) => {
            ...
            return We(["mord", "accentunder"], [i], t);
          },
          mathmlBuilder: (e, t) => {
            var r = _t(e.label),
              a = new Bt("munder", [Pt(e.base, t), r]);
            return (a.setAttribute("accentunder", "true"), a);
          },
        }));
      var ir = (e) => {
        var t = new Bt("mpadded", e ? [e] : []);
        return (
      ...
      (mt({
        ...
        htmlBuilder(e, t) {
          ...
          (i.classes.push(o + "-arrow-pad"),
            e.below &&
              ...
              (r = $e(St(e.below, n, t), t)).classes.push(o + "-arrow-pad")));
          var s,
            l = Kt(e, t),
        ...
        mathmlBuilder(e, t) {
          ...
          if (
            ...
            var n = ir(Pt(e.body, t));
            if (e.below) {
              var i = ir(Pt(e.below, t));
              r = new Bt("munderover", [a, i, n]);
            } else r = new Bt("mover", [a, n]);
          } else if (e.below) {
            var o = ir(Pt(e.below, t));
            r = new Bt("munder", [a, o]);
          } else ((r = ir()), (r = new Bt("mover", [a, r])));
          return r;
        },
      }),
        mt({
      ...
      (mt({
        ...
        htmlBuilder(e, t) {
          var r = t.havingStyle(t.style.sup()),
            a = $e(St(e.label, r, t), t);
          return (
            a.classes.push("cd-label-" + e.side),
            (a.style.bottom = E(0.8 - a.depth)),
            (a.height = 0),
            (a.depth = 0),
            a
          );
        ...
        mathmlBuilder(e, t) {
          var r = new Bt("mrow", [Pt(e.label, t)]);
          return (
            (r = new Bt("mpadded", [r])).setAttribute("width", "0"),
            "left" === e.side && r.setAttribute("lspace", "-1width"),
            r.setAttribute("voffset", "0.7em"),
            (r = new Bt("mstyle", [r])).setAttribute("displaystyle", "false"),
        ...
        mt({
          ...
          htmlBuilder(e, t) {
            var r = $e(St(e.fragment, t), t);
            return (r.classes.push("cd-vert-arrow"), r);
          },
          mathmlBuilder: (e, t) => new Bt("mrow", [Pt(e.fragment, t)]),
        }),
        mt({
          type: "textord",
          names: ["\\@char"],
          ...
          handler(e, t) {
            for (
              var { parser: r } = e,
                n = Jt(t[0], "ordgroup").body,
                i = "",
                o = 0;
              o < n.length;
              o++
            ) {
              i += Jt(n[o], "textord").text;
            }
            var s,
              l = parseInt(i);
            if (isNaN(l)) throw new a("\\@char has non-numeric argument " + i);
            if (l < 0 || l >= 1114111)
              throw new a("\\@char with invalid code point " + i);
            return (
              l <= 65535
      ...
      var dr = (e, t) => {
          var r = bt(e.body, t.withColor(e.color), !1);
          return _e(r);
        },
        gr = (e, t) => {
          var r = Dt(e.body, t.withColor(e.color)),
            a = new Bt("mstyle", r);
      ...
      (mt({
        ...
        handler(e, t) {
          var { parser: r } = e,
            a = Jt(t[0], "color-token").color,
            n = t[1];
          return { type: "color", mode: r.mode, color: a, body: pt(n) };
        },
        htmlBuilder: dr,
        mathmlBuilder: gr,
      }),
        ...
        mt({
          ...
          handler(e) {
            var { parser: t, funcName: r } = e,
              ...
              i = n.text;
            if (/^(?:[\\{}$&#^_]|EOF)$/.test(i))
              throw new a("Expected a control sequence", n);
      ...
      var yr = function (e, t, r) {
          var a = K((te.math[e] && te.math[e].replace) || e, t, r);
          if (!a)
            throw new Error(
        ...
        xr = function (e, t, r, a) {
          var n = r.havingBaseStyle(t),
            i = We(a.concat(n.sizingClasses(r)), [e], r),
        ...
        kr = function (e, t, r, a, n, i) {
          var o = (function (e, t, r, a) {
              return Pe(e, "Size" + t + "-Regular", r, a);
            })(e, t, n, a),
            s = xr(We(["delimsizing", "size" + t], [o], a), z.TEXT, a, i);
          return (r && wr(s, a, z.TEXT), s);
        },
        zr = function (e, t, r) {
          return {
            type: "elem",
        ...
        Sr = function (e, t, r) {
          var a = _["Size4-Regular"][e.charCodeAt(0)]
        ...
        Br = function (e, t, r, a, n, i) {
          ...
          if (m.length > 0) {
            ...
            ((N.height = q / 1e3),
              (N.style.width = H),
              (N.style.height = R),
              T.push({ type: "elem", elem: N }));
          } else {
            if ((T.push(zr(h, u, n)), T.push(Mr), null === s)) {
              var O = S - d - b + 0.016;
              T.push(Sr(l, O, a));
            } else {
              var D = (S - d - b - y) / 2 + 0.016;
              (T.push(Sr(l, D, a)),
                T.push(Mr),
                T.push(zr(s, u, n)),
                T.push(Mr),
            ...
            (T.push(Mr), T.push(zr(o, u, n)));
          }
          var L = a.havingBaseStyle(z.TEXT),
            P = Ze({ positionType: "bottom", positionData: A, children: T });
          return xr(We(["delimsizing", "mult"], [P], L), z.TEXT, a, i);
        },
        qr = 0.08,
        Cr = function (e, t, r, a, n) {
        ...
        Nr = function (e, t, r, n, i) {
          if (
            ...
            return kr(e, t, !1, r, n, i);
          if (Hr.has(e)) return Br(e, Er[t], !1, r, n, i);
        ...
        Vr = function (e, t, r, a) {
          for (var n = Math.min(2, 3 - a.style.size); n < r.length; n++) {
            var i = r[n];
            if ("stack" === i.type) break;
            var o = yr(e, Pr(i), "math"),
              s = o.height + o.depth;
            if ("small" === i.type)
              s *= a.havingBaseStyle(i.style).sizeMultiplier;
            if (s > t) return i;
          }
          return r[r.length - 1];
        },
        Fr = function (e, t, r, a, n, i) {
          ...
          ("<" === e || "\\lt" === e || "\u27e8" === e
            ? (e = "\\langle")
            : (">" !== e && "\\gt" !== e && "\u27e9" !== e) || (e = "\\rangle"),
            (o = Rr.has(e) ? Or : Ir.has(e) ? Lr : Dr));
          var s = Vr(e, t, o, a);
          return "small" === s.type
            ? (function (e, t, r, a, n, i) {
                var o = Pe(e, "Main-Regular", n, a),
                  s = xr(o, t, a, i);
                return (r && wr(s, a, t), s);
              })(e, s.style, r, a, n, i)
            : "large" === s.type
      ...
      (mt({
        ...
        htmlBuilder: (e, t) =>
          "." === e.delim
            ? We([e.mclass])
            : Nr(e.delim, e.size, t, e.mode, [e.mclass]),
        mathmlBuilder: (e) => {
          var t = [];
        ...
        mt({
          ...
          handler: (e, t) => {
            ...
            var i = Jt(a.parseFunction(), "leftright-right");
            return {
              type: "leftright",
              mode: a.mode,
              body: n,
          ...
          htmlBuilder: (e, t) => {
            ...
            if (
              ...
              (r =
                "." === e.left
                  ? zt(t, ["mopen"])
                  : Gr(e.left, i, o, t, e.mode, ["mopen"])),
              n.unshift(r),
              s)
            )
              for (var h = 1; h < n.length; h++) {
                var m = n[h].isMiddle;
                m && (n[h] = Gr(m.delim, i, o, m.options, e.mode, []));
              }
            if ("." === e.right) a = zt(t, ["mclose"]);
            else {
              var c = e.rightColor ? t.withColor(e.rightColor) : t;
              a = Gr(e.right, i, o, c, e.mode, ["mclose"]);
            }
            return (n.push(a), We(["minner"], n, t));
          },
          mathmlBuilder: (e, t) => {
            Xr(e);
            var r = Dt(e.body, t);
            if ("." !== e.left) {
              var a = new Bt("mo", [Rt(e.left, e.mode)]);
              (a.setAttribute("fence", "true"), r.unshift(a));
            }
            if ("." !== e.right) {
              var n = new Bt("mo", [Rt(e.right, e.mode)]);
      ...
      var jr = (e, t) => {
          ...
          if ("sout" === o)
            ...
            var d = Math.floor(1e3 * p * s),
              g =
                ...
                (a - 80) +
                " H400000z",
              f = new W([new X("phase", g)], {
                width: "400em",
                height: E(d / 1e3),
                viewBox: "0 0 400000 " + d,
                preserveAspectRatio: "xMinYMin slice",
              });
            (((r = Xe(["hide-tail"], [f], t)).style.height = E(p)),
              (l = i.depth + m + u));
          } else {
            /cancel/.test(o)
            ...
            (/box/.test(o)
              ...
              (r = (function (e, t, r, a, n) {
                ...
                if (/fbox|color|angl/.test(t)) {
                  ...
                  var h = new W(l, { width: "100%", height: E(o) });
                  i = Xe([], [h], n);
                }
                return ((i.height = o), (i.style.height = E(o)), i);
              })(i, o, v, b, t)),
              /fbox|boxed|fcolorbox/.test(o)
                ? ((r.style.borderStyle = "solid"),
                  (r.style.borderWidth = E(y)))
                : "angl" === o &&
                  0.049 !== y &&
                  ((r.style.borderTopWidth = E(y)),
                  (r.style.borderRightWidth = E(y))),
              (l = i.depth + b),
              e.backgroundColor &&
          ...
          return (
            ...
            /cancel/.test(o) && !h
              ? We(["mord", "cancel-lap"], [n], t)
              : We(["mord"], [n], t)
          );
        },
        _r = (e, t) => {
          var r = 0,
            a = new Bt(e.label.includes("colorbox") ? "mpadded" : "menclose", [
              Pt(e.body, t),
            ]);
          switch (e.label) {
            case "\\cancel":
      ...
      class ea {
        ...
        range(e, t) {
          return new ea(t, Qr.range(this, e));
        }
      }
      function ta(e) {
        var t = [];
      ...
      function ia(e, t, r) {
        ...
        function w() {
          y &&
            (e.gullet.macros.get("\\df@tag")
              ? (y.push(e.subparse([new ea("\\df@tag")])),
        ...
        for (x(), b.push(ta(e)); ; ) {
          ...
          (r && (z = { type: "styling", mode: e.mode, style: r, body: [z] }),
            g.push(z));
          var S = e.fetch().text;
          if ("&" === S) {
            if (u && g.length === u) {
      ...
      var sa = function (e, t) {
          ...
          function y(e) {
            for (var t = 0; t < e.length; ++t)
              (t > 0 && (b += 0.25), h.push({ pos: b, isDashed: e[t] }));
          }
          ...
          if (e.tags && e.tags.some((e) => e))
            for (r = 0; r < i; ++r) {
              ...
              (((P =
                !0 === L
                  ? We(["eqn-num"], [], t)
                  : We([], !1 === L ? [] : bt(L, t, !0), t)).depth = O.depth),
                (P.height = O.height),
                N.push({ type: "elem", elem: P, shift: D }));
            }
          for (n = 0, q = 0; n < s || q < I.length; ++n, ++q) {
            for (
              var V, F = I[q], G = !0;
              "separator" === (null == (U = F) ? void 0 : U.type);
            ) {
              var U;
              if (
                (G ||
                  (((B = We(["arraycolsep"], [])).style.width = E(
                    t.fontMetrics().doubleRuleSep,
                  )),
                  H.push(B)),
                "|" !== F.separator && ":" !== F.separator)
              )
                throw new a("Invalid separator type: " + F.separator);
              var Y = "|" === F.separator ? "solid" : "dashed",
                W = We(["vertical-separator"], [], t);
              ((W.style.height = E(b)),
                (W.style.borderRightWidth = E(m)),
                (W.style.borderRightStyle = Y),
                (W.style.margin = "0 " + E(-m / 2)));
              var X = b - C;
              (X && (W.style.verticalAlign = E(-X)),
                H.push(W),
                (F = I[++q]),
                (G = !1));
            }
            if (!(n >= s)) {
              ...
              if (n > 0 || e.hskipBeforeAndAfter)
                0 !==
                  ($ =
                    null != (j = null == (_ = F) ? void 0 : _.pregap)
                      ? j
                      : u) &&
                  (((B = We(["arraycolsep"], [])).style.width = E($)),
                  H.push(B));
              ...
              for (r = 0; r < i; ++r) {
                ...
                if (J) {
                  ...
                  ((J.depth = K.depth),
                    (J.height = K.height),
                    Z.push({ type: "elem", elem: J, shift: Q }));
                }
              }
              var ee,
                te,
                re = Ze({ positionType: "individualShift", children: Z }),
                ae = We(
                  [
                    "col-align-" +
                      ((null == (V = F) ? void 0 : V.align) || "c"),
                  ],
                  [re],
                );
              if ((H.push(ae), n < s - 1 || e.hskipBeforeAndAfter))
                0 !==
                  ($ =
                    null != (ee = null == (te = F) ? void 0 : te.postgap)
                      ? ee
                      : u) &&
                  (((B = We(["arraycolsep"], [])).style.width = E($)),
                  H.push(B));
          ...
          if (h.length > 0) {
            for (
              var ie = je("hline", t, m),
                oe = je("hdashline", t, m),
                se = [{ type: "elem", elem: ne, shift: 0 }];
              h.length > 0;
            ) {
              var le = h.pop(),
                he = le.pos - C;
              le.isDashed
                ? se.push({ type: "elem", elem: oe, shift: he })
                : se.push({ type: "elem", elem: ie, shift: he });
            }
            ne = Ze({ positionType: "individualShift", children: se });
          }
          if (0 === N.length) return We(["mord"], [ne], t);
          var me = Ze({ positionType: "individualShift", children: N }),
            ce = We(["tag"], [me], t);
          return _e([ne, ce]);
        },
        la = { c: "center ", l: "left ", r: "right " },
        ha = function (e, t) {
          for (
            var r = [],
              a = new Bt("mtd", [], ["mtr-glue"]),
              n = new Bt("mtd", [], ["mml-eqn-num"]),
              i = 0;
            i < e.body.length;
            i++
          ) {
            for (var o = e.body[i], s = [], l = 0; l < o.length; l++)
              s.push(new Bt("mtd", [Pt(o[l], t)]));
            (e.tags &&
              e.tags[i] &&
              (s.unshift(a), s.push(a), e.leqno ? s.unshift(n) : s.push(n)),
              r.push(new Bt("mtr", s)));
          }
          var h = new Bt("mtable", r),
            m =
              0.5 === e.arraystretch
                ? 0.1
                : 0.16 + e.arraystretch - 1 + (e.addJot ? 0.09 : 0);
          h.setAttribute("rowspacing", E(m));
          var c = "",
            u = "";
          ...
          if ("align" === e.colSeparationType) {
            for (var x = e.cols || [], w = "", k = 1; k < x.length; k++)
              w += k % 2 ? "0em " : "1em ";
          ...
          return (
            ...
            "" !== c &&
              (h = new Bt("menclose", [h])).setAttribute("notation", c.trim()),
            e.arraystretch &&
              e.arraystretch < 1 &&
              (h = new Bt("mstyle", [h])).setAttribute("scriptlevel", "1"),
            h
          );
        },
        ma = function (e, t) {
          ...
          o.body.forEach(function (e) {
            for (var t = 1; t < e.length; t += 2) {
              var r = Jt(e[t], "styling");
              Jt(r.body[0], "ordgroup").body.unshift(h);
            }
          ...
          for (var p = 0; p < l; ++p) {
            var d = "r",
              g = 0;
            (p % 2 == 1 ? (d = "l") : p > 0 && u && (g = 1),
              (r[p] = { type: "align", align: d, pregap: g, postgap: 0 }));
          }
      ...
      (Zr({
        ...
        props: { numArgs: 1 },
        handler(e, t) {
          var r = (er(t[0]) ? [t[0]] : Jt(t[0], "ordgroup").body).map(
              function (e) {
                var t = Qt(e).text;
          ...
          return ia(e.parser, n, oa(e.envName));
        },
        htmlBuilder: sa,
        mathmlBuilder: ha,
      }),
        Zr({
          ...
          handler(e) {
            ...
            var o = ia(e.parser, n, oa(e.envName)),
        ...
        Zr({
          ...
          props: { numArgs: 0 },
          handler(e) {
            var t = ia(e.parser, { arraystretch: 0.5 }, "script");
        ...
        Zr({
          ...
          props: { numArgs: 0 },
          handler(e) {
            aa.has(e.envName) && ra(e);
            var t = {
              cols: [{ type: "align", align: "c" }],
              addJot: !0,
              colSeparationType: "gather",
              autoTag: na(e.envName),
              emptySingleRow: !0,
              leqno: e.parser.settings.leqno,
            };
            return ia(e.parser, t, "display");
          },
          htmlBuilder: sa,
          mathmlBuilder: ha,
        }),
            ...
            (function (e) {
              ...
              for (
                ...
                if ("&" !== r && "\\\\" !== r) {
                  ...
                  throw new a("Expected \\\\ or \\cr or \\end", e.nextToken);
                }
                e.consume();
              }
              for (var n = [], i = [n], o = 0; o < t.length; o++) {
                for (var s = t[o], l = mr(), h = 0; h < s.length; h++)
                  if (cr(s[h])) {
                    n.push(l);
                    var m = Qt(s[(h += 1)]).text,
                      c = new Array(2);
                    if (
                      ...
                      if (!"<>AV".includes(m))
                        throw new a('Expected one of "<>AV=|." after @', s[h]);
                      for (var u = 0; u < 2; u++) {
      ...
      mt({
        ...
        handler(e, t) {
          ...
          if ("\\begin" === n) {
            ...
            r.expect("\\end", !1);
            var p = r.nextToken,
              d = Jt(r.parseFunction(), "environment");
            if (d.name !== o)
              throw new a(
      ...
      (mt({
        ...
        htmlBuilder: (e, t) => {
          ...
          if (
            (e.hasBarLine
              ? (e.barSize
                  ? ((m = R(e.barSize, t)), (h = je("frac-line", t, m)))
                  : (h = je("frac-line", t)),
                (m = h.height),
                (c = h.height))
              : ((h = null),
            ...
            (u - o.depth - (x + 0.5 * m) < p &&
              ...
              x - 0.5 * m - (y.height - d) < p &&
                (d += p - (x - 0.5 * m - (y.height - d))),
              (g = Ze({
                positionType: "individualShift",
                children: [
                  { type: "elem", elem: y, shift: d },
                  { type: "elem", elem: h, shift: -(x - 0.5 * m) },
          ...
          return (
            ...
            (f =
              a.size === z.DISPLAY.size
                ...
                : a.size === z.SCRIPTSCRIPT.size
                  ? t.havingStyle(z.SCRIPT).fontMetrics().delim2
                  : t.fontMetrics().delim2),
            (v =
              null == e.leftDelim
                ? zt(t, ["mopen"])
                : Fr(e.leftDelim, f, !0, t.havingStyle(a), e.mode, ["mopen"])),
            (b = e.continued
              ? We([])
              : null == e.rightDelim
                ? zt(t, ["mclose"])
                : Fr(e.rightDelim, f, !0, t.havingStyle(a), e.mode, [
                    "mclose",
                  ])),
            We(
        ...
        mathmlBuilder: (e, t) => {
          var r = new Bt("mfrac", [Pt(e.numer, t), Pt(e.denom, t)]);
          if (e.hasBarLine) {
            if (e.barSize) {
              var a = R(e.barSize, t);
              r.setAttribute("linethickness", E(a));
            }
          } else r.setAttribute("linethickness", "0px");
          if (null != e.leftDelim || null != e.rightDelim) {
            var n = [];
            if (null != e.leftDelim) {
              var i = new Bt("mo", [new qt(e.leftDelim.replace("\\", ""))]);
              (i.setAttribute("fence", "true"), n.push(i));
            }
            if ((n.push(r), null != e.rightDelim)) {
              var o = new Bt("mo", [new qt(e.rightDelim.replace("\\", ""))]);
      ...
      var fa = ["display", "text", "script", "scriptscript"],
        va = function (e) {
          var t = null;
      ...
      (mt({
        ...
        handler(e, t) {
          var r,
            ...
            i = t[5],
            o = ut(t[0]),
            s = "atom" === o.type && "open" === o.family ? va(o.text) : null,
            l = ut(t[1]),
            h = "atom" === l.type && "close" === l.family ? va(l.text) : null,
            m = Jt(t[2], "size"),
            c = null;
          ...
          if ("ordgroup" === p.type) {
            if (p.body.length > 0) {
              var d = Jt(p.body[0], "textord");
              u = fa[Number(d.text)];
            }
          } else ((p = Jt(p, "textord")), (u = fa[Number(p.text)]));
          return ga(
            {
              type: "genfrac",
              mode: a.mode,
        ...
        mt({
          ...
          handler: (e, t) => {
            ...
            if (!i)
              throw new Error(
                "\\\\abovefrac expected size, but got " + String(i),
              );
            var o = t[2],
              s = i.number > 0;
            return {
      ...
      var ba = (e, t) => {
        ...
        "supsub" === e.type
          ? ((r = e.sup
              ? St(e.sup, t.havingStyle(n.sup()), t)
              : St(e.sub, t.havingStyle(n.sub()), t)),
            (a = Jt(e.base, "horizBrace")))
          : (a = Jt(e, "horizBrace"));
        var i,
          o = St(a.base, t.havingBaseStyle(z.DISPLAY)),
          s = Kt(a, t);
        if (
          (a.isOver
            ? (i = Ze({
          ...
          var l = We(["mord", a.isOver ? "mover" : "munder"], [i], t);
          i = a.isOver
            ? Ze({
                positionType: "firstBaseline",
                children: [
        ...
        return We(["mord", a.isOver ? "mover" : "munder"], [i], t);
      };
      (mt({
        type: "horizBrace",
        ...
        mathmlBuilder: (e, t) => {
          var r = _t(e.label);
          return new Bt(e.isOver ? "mover" : "munder", [Pt(e.base, t), r]);
        },
      }),
        mt({
          type: "href",
          ...
          handler: (e, t) => {
            ...
            return r.settings.isTrusted({ command: "\\href", url: n })
              ? { type: "href", mode: r.mode, href: n, body: pt(a) }
        ...
        mt({
          ...
          handler: (e, t) => {
            ...
            return { type: "href", mode: r.mode, href: a, body: pt(s) };
          },
        }),
        mt({
          type: "hbox",
          ...
          handler(e, t) {
            var { parser: r } = e;
            return { type: "hbox", mode: r.mode, body: pt(t[0]) };
          },
          htmlBuilder(e, t) {
            var r = bt(e.body, t, !1);
            return _e(r);
          },
          mathmlBuilder: (e, t) => new Bt("mrow", Dt(e.body, t)),
        }),
        mt({
          type: "html",
          ...
          handler: (e, t) => {
            ...
            switch (i) {
              ...
              case "\\htmlData":
                for (var m = s.split(","), c = 0; c < m.length; c++) {
                  ...
                  if (p < 0)
                    throw new a(
                      "\\htmlData key/value '" + u + "' missing equals sign",
                    );
                  var d = u.slice(0, p),
                    g = u.slice(p + 1);
                  h["data-" + d.trim()] = g;
            ...
            return n.settings.isTrusted(r)
              ? { type: "html", mode: n.mode, attributes: h, body: pt(l) }
      ...
      (mt({
        ...
        handler: (e, t, r) => {
          ...
          if (r[0])
            for (
              var h = Jt(r[0], "raw").string.split(","), m = 0;
              m < h.length;
              m++
            ) {
              var c = h[m].split("=");
        ...
        htmlBuilder: (e, t) => {
          var r = R(e.height, t),
            a = 0;
          e.totalheight.number > 0 && (a = R(e.totalheight, t) - r);
          var n = 0;
          e.width.number > 0 && (n = R(e.width, t));
          var i = { height: E(r + a) };
          (n > 0 && (i.width = E(n)), a > 0 && (i.verticalAlign = E(-a)));
          var o = new G(e.src, e.alt, i);
        ...
        mathmlBuilder: (e, t) => {
          ...
          if (
            (e.totalheight.number > 0 &&
              ((n = R(e.totalheight, t) - a), r.setAttribute("valign", E(-n))),
            r.setAttribute("height", E(a + n)),
            e.width.number > 0)
          ) {
            var i = R(e.width, t);
        ...
        mt({
          ...
          htmlBuilder: (e, t) => Ke(e.dimension, t),
          mathmlBuilder(e, t) {
            var r = R(e.dimension, t);
            return new Ct(r);
          },
        }),
        mt({
          ...
          htmlBuilder: (e, t) => {
            var r;
            "clap" === e.alignment
              ? ((r = We([], [St(e.body, t)])), (r = We(["inner"], [r], t)))
              : (r = We(["inner"], [St(e.body, t)]));
            var a = We(["fix"], []),
              n = We([e.alignment], [r, a], t),
              i = We(["strut"]);
            return (
          ...
          mathmlBuilder: (e, t) => {
            var r = new Bt("mpadded", [Pt(e.body, t)]);
            if ("rlap" !== e.alignment) {
      ...
      var wa = (e, t, r, a, n, i, o) => {
          ...
          var s,
            ...
            m = r && c(r);
          if (t) {
            var u = St(t, a.havingStyle(n.sup()), a);
            l = {
              elem: u,
              kern: Math.max(
          ...
          if (r) {
            var p = St(r, a.havingStyle(n.sub()), a);
            s = {
              elem: p,
              kern: Math.max(
          ...
          if (l && s) {
            ...
            h = Ze({
              ...
              children: [
                ...
                { type: "elem", elem: s.elem, marginLeft: E(-i) },
                { type: "kern", size: s.kern },
                { type: "elem", elem: e },
                { type: "kern", size: l.kern },
                { type: "elem", elem: l.elem, marginLeft: E(i) },
                { type: "kern", size: a.fontMetrics().bigOpSpacing5 },
              ],
            });
          } else if (s) {
          ...
          if (s && 0 !== i && !m) {
            var b = We(["mspace"], [], a);
            ((b.style.marginRight = E(i)), v.unshift(b));
          }
          return We(["mop", "op-limits"], v, a);
        },
        ka = new Set(["\\smallint"]),
        za = (e, t) => {
          var r,
            ...
            i = !1;
          "supsub" === e.type
            ? ((r = e.sup), (a = e.sub), (n = Jt(e.base, "op")), (i = !0))
            : (n = Jt(e, "op"));
          var o,
            s = t.style,
            l = !1;
          if (
            ...
            var p = bt(n.body, t, !0);
            1 === p.length && p[0] instanceof Y
              ? ((o = p[0]).classes[0] = "mop")
              : (o = We(["mop"], p, t));
          } else {
            for (var d = [], g = 1; g < n.name.length; g++)
              d.push(Ve(n.name[g], n.mode, t));
            o = We(["mop"], d, t);
          }
          var f = 0,
            v = 0;
          return (
            (o instanceof Y || "\\oiint" === n.name || "\\oiiint" === n.name) &&
              !n.suppressBaseShift &&
              ((f = (o.height - o.depth) / 2 - t.fontMetrics().axisHeight),
              (v = o.italic || 0)),
            i
              ? wa(o, r, a, t, s, v, f)
              : (f && ((o.style.position = "relative"), (o.style.top = E(f))),
                o)
          );
        },
        Sa = (e, t) => {
          var r;
          if (e.symbol)
            ((r = new Bt("mo", [Rt(e.name, e.mode)])),
              ka.has(e.name) && r.setAttribute("largeop", "false"));
          else if (e.body) r = new Bt("mo", Dt(e.body, t));
          else {
            r = new Bt("mi", [new qt(e.name.slice(1))]);
            var a = new Bt("mo", [Rt("\u2061", "text")]);
            r = e.parentIsSupSub ? new Bt("mrow", [r, a]) : Tt([r, a]);
          }
          return r;
        },
        Ma = {
      ...
      var Ta = (e, t) => {
        ...
        return o ? wa(i, r, a, t, t.style, 0, 0) : i;
      };
      function Ba(e, t, r) {
        for (
          var a = bt(e, t, !1), n = t.sizeMultiplier / r.sizeMultiplier, i = 0;
          i < a.length;
          i++
        ) {
      ...
      (mt({
        ...
        mathmlBuilder: (e, t) => {
          for (
            var r = Dt(e.body, t.withFont("mathrm")), a = !0, n = 0;
            n < r.length;
            n++
          ) {
            var i = r[n];
            if (i instanceof Ct);
              ...
              switch (i.type) {
                ...
                case "mo":
                  var o = i.children[0];
                  1 === i.children.length && o instanceof qt
                    ? (o.text = o.text
                        .replace(/\u2212/, "-")
                        .replace(/\u2217/, "*"))
                    : (a = !1);
          ...
          var h = new Bt("mo", [Rt("\u2061", "text")]);
          return e.parentIsSupSub ? new Bt("mrow", [l, h]) : Tt([l, h]);
        },
      }),
        Jr(
          "\\operatorname",
        ...
        mt({
          ...
          htmlBuilder(e, t) {
            ...
            return We(["mord", "overline"], [i], t);
          },
          mathmlBuilder(e, t) {
            var r = new Bt("mo", [new qt("\u203e")]);
            r.setAttribute("stretchy", "true");
            var a = new Bt("mover", [Pt(e.body, t), r]);
            return (a.setAttribute("accent", "true"), a);
          },
        }),
        mt({
          ...
          handler: (e, t) => {
            var { parser: r } = e,
              a = t[0];
            return { type: "phantom", mode: r.mode, body: pt(a) };
          },
          htmlBuilder: (e, t) => {
            var r = bt(e.body, t.withPhantom(), !1);
            return _e(r);
          },
          mathmlBuilder: (e, t) => {
            var r = Dt(e.body, t);
        ...
        mt({
          ...
          htmlBuilder: (e, t) => {
            var r = We(["inner"], [St(e.body, t.withPhantom())]),
              a = We(["fix"], []);
            return We(["mord", "rlap"], [r, a], t);
          },
          mathmlBuilder: (e, t) => {
            var r = Dt(pt(e.body), t),
              a = new Bt("mphantom", r),
              n = new Bt("mpadded", [a]);
        ...
        mt({
          ...
          handler(e, t, r) {
            ...
            return {
              type: "rule",
              mode: a.mode,
              shift: n && Jt(n, "size").value,
              width: i.value,
              height: o.value,
            };
          },
          htmlBuilder(e, t) {
            var r = We(["mord", "rule"], [], t),
              a = R(e.width, t),
              n = R(e.height, t),
              i = e.shift ? R(e.shift, t) : 0;
            return (
              (r.style.borderRightWidth = E(a)),
              (r.style.borderTopWidth = E(n)),
              (r.style.bottom = E(i)),
              (r.width = a),
              (r.height = n + i),
              (r.depth = -i),
          ...
          mathmlBuilder(e, t) {
            var r = R(e.width, t),
              a = R(e.height, t),
              n = e.shift ? R(e.shift, t) : 0,
              i = (t.color && t.getColor()) || "black",
              o = new Bt("mspace");
            (o.setAttribute("mathbackground", i),
              o.setAttribute("width", E(r)),
              o.setAttribute("height", E(a)));
            var s = new Bt("mpadded", [o]);
            return (
              n >= 0
                ? s.setAttribute("height", E(n))
                : (s.setAttribute("height", E(n)),
                  s.setAttribute("depth", E(-n))),
              s.setAttribute("voffset", E(n)),
              s
            );
          },
        }));
      ...
      (mt({
        ...
        htmlBuilder: (e, t) => {
          ...
          return Ba(e.body, r, t);
        },
        mathmlBuilder: (e, t) => {
          var r = t.havingSize(e.size),
            a = Dt(e.body, r),
            n = new Bt("mstyle", a);
          return (n.setAttribute("mathsize", E(r.sizeMultiplier)), n);
        },
      }),
        mt({
          type: "smash",
          ...
          handler: (e, t, r) => {
            var { parser: a } = e,
              n = !1,
              i = !1,
              o = r[0] && Jt(r[0], "ordgroup");
            if (o)
              for (var s = "", l = 0; l < o.body.length; ++l) {
                if ("t" === (s = Qt(o.body[l]).text)) n = !0;
                else {
                  if ("b" !== s) {
                    ((n = !1), (i = !1));
                    break;
        ...
        mt({
          ...
          htmlBuilder(e, t) {
            ...
            var i = a + n / 4,
              o = r.height + r.depth + i + a,
              {
                ...
                var r,
                  ...
                  i = Vr("\\surd", e * n.sizeMultiplier, Lr, n),
                  o = n.sizeMultiplier,
                  s = Math.max(
                    0,
                  ...
                  "small" === i.type
                    ...
                    : "large" === i.type
                      ...
                      : ((l = e + s + qr),
                        ...
                        ((r = Cr("sqrtTall", l, m, s, t)).style.minWidth =
                          "0.742em"),
                        (a = 1.056)),
                  (r.height = h),
                  (r.style.height = E(l)),
            ...
            if (e.index) {
              var p = t.havingStyle(z.SCRIPTSCRIPT),
                d = St(e.index, p, t),
                ...
                v = We(["root"], [f]);
              return We(["mord", "sqrt"], [v, u], t);
            }
            return We(["mord", "sqrt"], [u], t);
          },
          mathmlBuilder(e, t) {
            var { body: r, index: a } = e;
            return a
              ? new Bt("mroot", [Pt(r, t), Pt(a, t)])
              : new Bt("msqrt", [Pt(r, t)]);
          },
        }));
      var Ca = {
      ...
      (ct({
        ...
        htmlBuilder(e, t) {
          ...
          i =
            t.style === z.DISPLAY ? m.sup1 : t.style.cramped ? m.sup3 : m.sup2;
          var v,
            b = t.sizeMultiplier,
            y = E(0.5 / m.ptPerEm / b),
            x = null;
          if (n) {
            ...
            (h instanceof Y || w) && (x = E(-h.italic));
          }
          if (a && n) {
            ((u = Math.max(u, i, a.depth + 0.25 * m.xHeight)),
              (p = Math.max(p, m.sub2)));
            var k = 4 * m.defaultRuleThickness;
            if (u - a.depth - (n.height - p) < k) {
              p = k - (u - a.depth) + n.height;
              var S = 0.8 * m.xHeight - (u - a.depth);
              S > 0 && ((u += S), (p -= S));
            }
            v = Ze({
              positionType: "individualShift",
              children: [
                ...
                { type: "elem", elem: a, shift: -u, marginRight: y },
              ],
            });
          } else if (n) {
          ...
          var M = kt(h, "right") || "mord";
          return We([M], [h, We(["msupsub"], [v])], t);
        },
        mathmlBuilder(e, t) {
          var r,
            a = !1;
          ...
          var n,
            i = [Pt(e.base, t)];
          if ((e.sub && i.push(Pt(e.sub, t)), e.sup && i.push(Pt(e.sup, t)), a))
            n = r ? "mover" : "munder";
          else if (e.sub)
            if (e.sup) {
              var o = e.base;
              n =
                (o && "op" === o.type && o.limits && t.style === z.DISPLAY) ||
                (o &&
                  "operatorname" === o.type &&
                  o.alwaysHandleSupSub &&
                  (t.style === z.DISPLAY || o.limits))
                  ? "munderover"
                  : "msubsup";
            } else {
              var s = e.base;
              n =
                (s &&
                  "op" === s.type &&
                  s.limits &&
                  (t.style === z.DISPLAY || s.alwaysHandleSupSub)) ||
                (s &&
                  "operatorname" === s.type &&
                  s.alwaysHandleSupSub &&
                  (s.limits || t.style === z.DISPLAY))
                  ? "munder"
                  : "msub";
            }
          else {
            ...
            n =
              (l &&
                "op" === l.type &&
                l.limits &&
                (t.style === z.DISPLAY || l.alwaysHandleSupSub)) ||
              (l &&
                "operatorname" === l.type &&
        ...
        ct({
          type: "atom",
          htmlBuilder: (e, t) => Ve(e.text, e.mode, t, ["m" + e.family]),
          mathmlBuilder(e, t) {
            var r = new Bt("mo", [Rt(e.text, e.mode)]);
            if ("bin" === e.family) {
              var a = Nt(e, t);
      ...
      var Ia = { mi: "italic", mn: "normal", mtext: "normal" };
      (ct({
        type: "mathord",
        htmlBuilder: (e, t) => Fe(e, t, "mathord"),
        mathmlBuilder(e, t) {
          var r = new Bt("mi", [Rt(e.text, e.mode, t)]),
            a = Nt(e, t) || "italic";
          return (a !== Ia[r.type] && r.setAttribute("mathvariant", a), r);
        },
      }),
        ct({
          type: "textord",
          htmlBuilder: (e, t) => Fe(e, t, "textord"),
          mathmlBuilder(e, t) {
            var r,
              a = Rt(e.text, e.mode, t),
              n = Nt(e, t) || "normal";
            return (
              (r =
                "text" === e.mode
                  ...
                  : /[0-9]/.test(e.text)
                    ...
                    : "\\prime" === e.text
                      ? new Bt("mo", [a])
                      : new Bt("mi", [a])),
              n !== Ia[r.type] && r.setAttribute("mathvariant", n),
              r
            );
          },
        }));
      ...
      ct({
        ...
        htmlBuilder(e, t) {
          if (Ra.hasOwnProperty(e.text)) {
            var r = Ra[e.text].className || "";
            if ("text" === e.mode) {
              var n = Fe(e, t, "textord");
              return (n.classes.push(r), n);
            }
            return We(["mspace", r], [Ve(e.text, e.mode, t)], t);
          }
          if (Ha.hasOwnProperty(e.text))
            return We(["mspace", Ha[e.text]], [], t);
          throw new a('Unknown type of space "' + e.text + '"');
        },
        mathmlBuilder(e, t) {
          if (!Ra.hasOwnProperty(e.text)) {
            if (Ha.hasOwnProperty(e.text)) return new Bt("mspace");
            throw new a('Unknown type of space "' + e.text + '"');
          }
          return new Bt("mtext", [new qt("\xa0")]);
        },
      });
      var Ea = () => {
        var e = new Bt("mtd", []);
      ...
      ct({
        ...
        mathmlBuilder(e, t) {
          var r = new Bt("mtable", [
            new Bt("mtr", [
              Ea(),
              new Bt("mtd", [Lt(e.body, t)]),
              Ea(),
              new Bt("mtd", [Lt(e.tag, t)]),
            ]),
          ]);
      ...
      var Na = {
        ...
        Oa = { "\\textbf": "textbf", "\\textmd": "textmd" },
        Da = { "\\textit": "textit", "\\textup": "textup" },
        La = (e, t) => {
          var r = e.font;
          return r
            ? Na[r]
              ? t.withTextFontFamily(Na[r])
              : Oa[r]
                ? t.withTextFontWeight(Oa[r])
                : "\\emph" === r
                  ? "textit" === t.fontShape
                    ? t.withTextFontShape("textup")
                    : t.withTextFontShape("textit")
                  : t.withTextFontShape(Da[r])
            : t;
        };
      (mt({
        type: "text",
        ...
        handler(e, t) {
          var { parser: r, funcName: a } = e,
            n = t[0];
          return { type: "text", mode: r.mode, body: pt(n), font: a };
        },
        htmlBuilder(e, t) {
          var r = La(e, t),
            a = bt(e.body, r, !0);
          return We(["mord", "text"], a, r);
        },
        mathmlBuilder(e, t) {
          var r = La(e, t);
          return Lt(e.body, r);
        ...
        mt({
          ...
          htmlBuilder(e, t) {
            ...
            return We(["mord", "underline"], [i], t);
          },
          mathmlBuilder(e, t) {
            var r = new Bt("mo", [new qt("\u203e")]);
            r.setAttribute("stretchy", "true");
            var a = new Bt("munder", [Pt(e.body, t), r]);
            return (a.setAttribute("accentunder", "true"), a);
          },
        }),
        mt({
          ...
          mathmlBuilder: (e, t) =>
            new Bt("mpadded", [Pt(e.body, t)], ["vcenter"]),
        }),
        mt({
          type: "verb",
          names: ["\\verb"],
          ...
          htmlBuilder(e, t) {
            for (
              var r = Pa(e), a = [], n = t.havingStyle(t.style.text()), i = 0;
              i < r.length;
              i++
            ) {
              var o = r[i];
              ("~" === o && (o = "\\textasciitilde"),
                a.push(
                  Pe(o, "Typewriter-Regular", e.mode, n, ["mord", "texttt"]),
                ));
            }
            return We(["mord", "text"].concat(n.sizingClasses(t)), Ue(a), n);
          },
          mathmlBuilder(e, t) {
            var r = new qt(Pa(e)),
              a = new Bt("mtext", [r]);
      ...
      var Pa = (e) => e.body.replace(/ /g, e.star ? "\u2423" : "\xa0"),
        Va = st,
        Fa = "[ \r\n\t]",
        Ga = "(\\\\[a-zA-Z@]+)" + Fa + "*",
        Ua = "[\u0300-\u036f]",
      ...
      class Xa {
        constructor(e, t) {
          ((this.input = e),
            (this.settings = t),
            (this.tokenRegex = new RegExp(Wa, "g")),
            (this.catcodes = { "%": 14, "~": 13 }));
        }
        setCatcode(e, t) {
          this.catcodes[e] = t;
        ...
        lex() {
          ...
          if (t === e.length) return new ea("EOF", new Qr(this, t, t));
          var r = this.tokenRegex.exec(e);
          if (null === r || r.index !== t)
            throw new a(
              "Unexpected character: '" + e[t] + "'",
              new ea(e[t], new Qr(this, t, t + 1)),
            );
          var n = r[6] || r[3] || (r[2] ? "\\ " : " ");
          ...
          return new ea(n, new Qr(this, t, this.tokenRegex.lastIndex));
        }
      }
      class ja {
        constructor(e, t) {
      ...
      Jr("\\char", function (e) {
        ...
        if (t) {
          if (null == (n = $a[r.text]) || n >= t)
            throw new a("Invalid base-" + t + " digit " + r.text);
          for (var i; null != (i = $a[e.future().text]) && i < t; )
            ((n *= t), (n += i), e.popToken());
        }
        return "\\@char{" + n + "}";
      });
      ...
      (Jr("\\newcommand", (e) => Za(e, !1, !0, !1)),
        Jr("\\renewcommand", (e) => Za(e, !0, !1, !1)),
        Jr("\\providecommand", (e) => Za(e, !0, !0, !0)),
        Jr("\\message", (e) => {
        ...
        Jr("\\show", (e) => {
          var t = e.popToken(),
            r = t.text;
          return (
            console.log(t, e.macros.get(r), Va[r], te.math[r], te.text[r]),
            ""
          );
        }),
        Jr("\\bgroup", "{"),
      ...
      Jr("\\dots", function (e) {
        ...
        return (
          r in Ka
            ? (t = Ka[r])
            : ("\\not" === r.slice(0, 4) ||
                (r in te.math && Ja.has(te.math[r].group))) &&
              (t = "\\dotsb"),
          t
        );
      });
      ...
      (Jr("\\dotso", function (e) {
        return e.future().text in Qa ? "\\ldots\\," : "\\ldots";
      }),
        Jr("\\dotsc", function (e) {
          var t = e.future().text;
          return t in Qa && "," !== t ? "\\ldots\\," : "\\ldots";
        }),
        Jr("\\cdots", function (e) {
          return e.future().text in Qa ? "\\@cdots\\," : "\\@cdots";
        }),
        Jr("\\dotsb", "\\cdots"),
        Jr("\\dotsm", "\\cdots"),
        Jr("\\dotsi", "\\!\\cdots"),
      ...
      var rn = { "^": !0, _: !0, "\\limits": !0, "\\nolimits": !0 };
      class an {
        constructor(e, t, r) {
          ((this.settings = t),
            (this.expansionCount = 0),
            this.feed(e),
            (this.macros = new ja(_a, t.macros)),
            (this.mode = r),
            (this.stack = []));
        }
        feed(e) {
        ...
        consumeArgs(e, t) {
          if (t) {
            ...
            for (var r = t[0], n = 0; n < r.length; n++) {
              var i = this.popToken();
              if (r[n] !== i.text)
                throw new a("Use of the macro doesn't match its definition", i);
            }
          }
          for (var o = [], s = 0; s < e; s++)
        ...
        _getExpansion(e) {
          ...
          if ("string" == typeof a) {
            var n = 0;
            if (a.includes("#"))
              for (var i = a.replace(/##/g, ""); i.includes("#" + (n + 1)); )
                ++n;
            for (
              var o = new Xa(a, this.settings), s = [], l = o.lex();
              "EOF" !== l.text;
            )
              (s.push(l), (l = o.lex()));
        ...
        isDefined(e) {
          return (
            this.macros.has(e) ||
            Va.hasOwnProperty(e) ||
            te.math.hasOwnProperty(e) ||
            te.text.hasOwnProperty(e) ||
            rn.hasOwnProperty(e)
          );
        }
        isExpandable(e) {
          ...
          return null != t
            ...
            : Va.hasOwnProperty(e) && !Va[e].primitive;
        }
      }
      var nn =
      ...
      class hn {
        constructor(e, t) {
          ((this.mode = "math"),
            (this.gullet = new an(e, t, this.mode)),
            (this.settings = t),
        ...
        parseExpression(e, t) {
          for (var r = []; ; ) {
            ...
            var a = this.fetch();
            if (hn.endOfExpression.has(a.text)) break;
            if (t && a.text === t) break;
            if (e && Va[a.text] && Va[a.text].infix) break;
        ...
        handleInfixNodes(e) {
          for (var t, r = -1, n = 0; n < e.length; n++) {
            ...
            if ("infix" === i.type) {
              if (-1 !== r)
                throw new a("only one infix operator per group", i.token);
              ((r = n), (t = i.replaceWith));
            }
          }
          if (-1 !== r && t) {
            ...
            return (
              ...
              [
                "\\\\abovefrac" === t
                  ? this.callFunction(t, [o, e[r], s], [])
                  : this.callFunction(t, [o, s], []),
              ]
            );
          }
          return e;
        ...
        handleSupSubscript(e) {
          ...
          if (!t) throw new a("Expected group after '" + n + "'", r);
          return t;
        }
        ...
        parseAtom(e) {
          ...
          for (;;) {
            ...
            if ("\\limits" === i.text || "\\nolimits" === i.text) {
              ...
              if (r) throw new a("Double subscript", i);
              ...
              if (!on[i.text]) break;
              var h = nn.test(i.text),
                m = [];
              for (m.push(new ea(on[i.text])), this.consume(); ; ) {
                var c = this.fetch().text;
                if (!on[c]) break;
                if (nn.test(c) !== h) break;
                (m.unshift(new ea(on[c])), this.consume());
              }
        ...
        parseFunction(e, t) {
          ...
          if ("text" === this.mode && !i.allowedInText)
            throw new a("Can't use function '" + n + "' in text mode", r);
          if ("math" === this.mode && !1 === i.allowedInMath)
            throw new a("Can't use function '" + n + "' in math mode", r);
        ...
        parseSizeGroup(e) {
          ...
          if (!H(i)) throw new a("Invalid unit: '" + i.unit + "'", t);
        ...
        parseSymbol() {
          ...
          if ((this.consume(), o))
            for (var c = 0; c < o[0].length; c++) {
              var u = o[0][c];
              if (!sn[u]) throw new a("Unknown accent ' " + u + "'", e);
              var p = sn[u][this.mode] || sn[u].text;
              if (!p)
                throw new a(
        ...
        pn = function (e, t) {
          ...
          try {
            return (function (e, t, r) {
              var a,
                n = Wt(r);
              if ("mathml" === r.output) return Vt(e, t, n, r.displayMode, !0);
              if ("html" === r.output) {
                var i = At(e, n);
                a = We(["katex"], [i]);
              } else {
                var o = Vt(e, t, n, r.displayMode, !1),
                  s = At(e, n);
                a = We(["katex"], [o, s]);
              }
              return Xt(a, r);

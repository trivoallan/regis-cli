  ...
  [4583],
  {
    ...
    65866(e, r, s) {
      ...
      function d({ archives: e, activeIndex: r, onSelect: s }) {
        const t = r + 1;
        const a = [
          (0, c.jsx)(i.oz, { children: "All Archives" }, "__all__"),
          ...e.map((e) => (0, c.jsx)(i.oz, { children: e.name }, e.path)),
        ];
        return (0, c.jsx)(i.fu, {
          index: t,
          ...
          children: (0, c.jsx)(i.wb, { children: a }),
        });
      }
      function h(e) {
      ...
      function g(e, r) {
        return fetch(e)
          .then((e) => {
            ...
            if (!r.includes("application/json") && !r.includes("text/plain"))
              throw new Error(
      ...
      function v() {
        ...
        ((0, t.useEffect)(() => {
          ...
          (0, t.useEffect)(() => {
            if (Y.length >= 2)
              if ((y(!0), -1 === D))
                Promise.all(
                  Y.map((e) => g(new URL(e.path, U).toString(), e.name)),
                )
                  .then((e) => {
                    const r = e
                      .flat()
        ...
        const P = (0, t.useMemo)(
            () =>
              v.filter((e) => {
                if (k && !h(e).toLowerCase().includes(k.toLowerCase()))
                  return !1;
                if ("All" !== _) {
        ...
        if (w)
          return (0, c.jsx)("div", {
            ...
            children: (0, c.jsx)(i.EY, { children: "Loading archive\u2026" }),
          });
        if (N) {
          const e =
            N.startsWith("404 ") ||
            ...
            N.includes("not a valid JSON") ||
            N.includes("Invalid archive format") ||
        ...
        return (0, c.jsxs)("div", {
          ...
          children: [
            (0, c.jsxs)("div", {
              ...
              children: [
                (0, c.jsx)(i.hE, { children: B ? q : "Report Archive" }),
                (0, c.jsx)(i.EY, {
                  children:
            ...
            (0, c.jsxs)(i.so, {
              ...
              children: [
                ...
                (0, c.jsx)(i.l6, {
                  ...
                  children: f.map((e) =>
                    (0, c.jsx)(i.eb, { value: e, children: e }, e),
                  ),
                }),
                (0, c.jsx)(i.l6, {
                  value: C,
              ...
              (0, c.jsxs)("section", {
                children: [
                  (0, c.jsxs)("div", {
                    ...
                    children: [
                      (0, c.jsx)(i.hE, { children: "Images" }),
                      (0, c.jsx)(i.Ex, { color: "gray", children: F.length }),
                    ],
                  }),
                  (0, c.jsx)("div", {
            ...
            (0, c.jsxs)("section", {
              children: [
                ...
                0 === P.length
                  ? (0, c.jsx)(i.Zp, {
                      children: (0, c.jsx)(i.EY, {
                        children: "No reports match the current filters.",
                      }),
                    })
                  : (0, c.jsx)(i.Zp, {
                      className: "p-0 overflow-hidden",
                      children: (0, c.jsxs)(i.XI, {
                        children: [
                          (0, c.jsx)(i.nd, {
                            className: "bg-gray-50 dark:bg-gray-800/50",
                            children: (0, c.jsxs)(i.Hj, {
                              children: [
                                (0, c.jsx)(i.M_, { children: "Date" }),
                                (0, c.jsx)(i.M_, { children: "Image" }),
                                J && (0, c.jsx)(i.M_, { children: "Source" }),
                                (0, c.jsx)(i.M_, { children: "Status" }),
                                (0, c.jsx)(i.M_, { children: "Tier" }),
                                (0, c.jsx)(i.M_, { children: "Score" }),
                                (0, c.jsx)(i.M_, { children: "Rules" }),
                                (0, c.jsx)(i.M_, { children: "CVE C/H" }),
                                (0, c.jsx)(i.M_, {

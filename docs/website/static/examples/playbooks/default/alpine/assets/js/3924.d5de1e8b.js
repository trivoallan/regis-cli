  ...
  [3924],
  {
              ...
              (l && (u = r[2]),
                ...
                (this.$d = (function (t, e, n, i) {
                  try {
                    ...
                    return h
                      ? new Date(
                          Date.UTC(g, p, k, v, b, x, w + 60 * h.offset * 1e3),
                        )
                      : n
                        ? new Date(Date.UTC(g, p, k, v, b, x, w))
                        : ((T = new Date(g, p, k, v, b, x, w)),
                          m && (T = i(T).week(m).toDate()),
                          T);
                  } catch (t) {
                    return new Date("");
                  }
      ...
      t.exports = (function () {
        ...
        return function (n, i, s) {
          ...
          ((i.prototype.add = function (t, e) {
            return u(t) ? T(this, t, 1) : r.bind(this)(t, e);
          }),
            (i.prototype.subtract = function (t, e) {
              return u(t) ? T(this, t, -1) : a.bind(this)(t, e);
            }));
        };
      })();
    },
    ...
    33924(t, e, n) {
            ...
            C = {
              ...
              parse: (0, r.K2)(function (t) {
                ...
                ("function" == typeof m.yy.parseError
                  ...
                  (0, r.K2)(p, "lex"));
                for (var T, v, b, x, w, $, _, D, C, S = {}; ; ) {
                  if (
                    ((b = n[n.length - 1]),
                    this.defaultActions[b]
                      ? (x = this.defaultActions[b])
                      : (null == T && (T = p()), (x = o[b] && o[b][T])),
      ...
      var y,
        ...
        bt = (0, r.K2)(function (t) {
          const e = Tt[t];
          return pt[e];
        }, "findTaskById"),
        xt = (0, r.K2)(function (t, e) {
          const n = {
              section: C,
              type: C,
              description: t,
            ...
            draw: (0, r.K2)(function (t, e, n, i) {
                ...
                (f
                  ...
                  .attr("width", function (t) {
                    return t.milestone
                      ...
                      : t.vert
                        ? 0.08 * c
                        : T(t.renderEndTime || t.endTime) - T(t.startTime);
                  })
                  ...
                  f
                    ...
                    .attr("x", function (t) {
                      let e = T(t.startTime),
                        n = T(t.renderEndTime || t.endTime);
                      if (
                        (t.milestone &&
                          ((e +=
                            0.5 * (T(t.endTime) - T(t.startTime)) - 0.5 * c),
                          (n = e + c)),
                        t.vert)
                      )
                        return T(t.startTime) + o;
              ...
              function w(t, e, n, s, c, l, d, u) {
                ...
                p.append("g")
                  ...
                  .attr("x", (t) => T(t.start.startOf("day")) + n)
                  .attr("y", a.gridLineStartPadding)
                  .attr(
                    "width",
                    (t) => T(t.end.endOf("day")) - T(t.start.startOf("day")),
                  )

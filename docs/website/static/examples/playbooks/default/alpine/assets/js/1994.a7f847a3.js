    ...
    31994(t, n, e) {
          ...
          return (
            ...
            (function ({ nodes: t }) {
              for (const n of t)
                n.value =
                  void 0 === n.fixedValue
                    ? Math.max(l(n.sourceLinks, p), l(n.targetLinks, p))
                    : n.fixedValue;
            })(a),
            (function ({ nodes: t }) {
              const n = t.length;
            ...
            (function (e) {
              ...
              ((t = Math.min(b, (c - s) / (h(a, (t) => t.length) - 1))),
                (function (n) {
                  const e = o(n, (n) => (c - s - (n.length - 1) * t) / l(n, p));
                  for (const i of n) {
                    let n = s;
                    for (const s of i) {
      ...
      E.prototype = K.prototype = {
        ...
        arc: function (t, n, e, i, s, r) {
          ...
          (null === this._x1
            ? (this._ += "M" + a + "," + l)
            : (Math.abs(this._x1 - a) > L || Math.abs(this._y1 - l) > L) &&
              (this._ += "L" + a + "," + l),
            e &&
              (u < 0 && (u = (u % w) + w),
              u > S
      ...
      var F = U,
        ...
        et = (0, s.K2)(function (t, n, e, o) {
          const { securityLevel: c, sankey: a } = (0, i.D7)(),
            l = i.ME.sankey;
          let h;
          ...
          const u =
            ...
            y = a?.width ?? l.width,
            d = a?.height ?? l.width,
            p = a?.useMaxWidth ?? l.useMaxWidth,
            g = a?.nodeAlignment ?? l.nodeAlignment,
            _ = a?.prefix ?? l.prefix,
            k = a?.suffix ?? l.suffix,
            x = a?.showValues ?? l.showValues,
            m = o.db.getGraph(),
            b = nt[g];
          v()
            .nodeId((t) => t.id)

          ...
          renderer: {
            draw: (0, s.K2)((e, t, a, l) => {
              ...
              const x = d.textPosition,
                b = Math.min(h, g) / 2 - 40,
                D = (0, c.JLW)().innerRadius(0).outerRadius(b),
                T = (0, c.JLW)()
                  .innerRadius(b * x)
                  .outerRadius(b * x);
              m.append("circle")
              ...
              (m
                ...
                m
                  ...
                  .attr("transform", (e) => "translate(" + T.centroid(e) + ")")
              ...
              (f.attr("viewBox", `0 0 ${M} 450`),
                (0, r.a$)(f, g, M, d.useMaxWidth));
            }, "draw"),
          },
          styles: v,
        };

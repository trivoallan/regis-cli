...
- **build:** pin tailwindcss to v3 and ignore v4 Dependabot bumps ([#164](https://github.com/trivoallan/regis-cli/issues/164))

### 📚 Documentation

- Update documentation reference and snapshots ([#163](https://github.com/trivoallan/regis-cli/issues/163))

---

## [v0.23.6](https://github.com/trivoallan/regis-cli/compare/v0.23.5...v0.23.6) — March 30, 2026
...
- Update documentation reference and snapshots ([#161](https://github.com/trivoallan/regis-cli/issues/161))

---

## [v0.23.5](https://github.com/trivoallan/regis-cli/compare/v0.23.4...v0.23.5) — March 30, 2026
...
- **docs:** resolve Docusaurus broken links and anchor warnings ([#159](https://github.com/trivoallan/regis-cli/issues/159))
- **docs:** revert versioned_docs additions and add release snapshot workflow ([#160](https://github.com/trivoallan/regis-cli/issues/160))

### 📚 Documentation

- Update documentation reference and snapshots ([#157](https://github.com/trivoallan/regis-cli/issues/157))

---

## [v0.23.4](https://github.com/trivoallan/regis-cli/compare/v0.23.3...v0.23.4) — March 30, 2026
...
- **build:** use pnpm direct install and sync serialize-javascript override ([#155](https://github.com/trivoallan/regis-cli/issues/155))

---

## [v0.23.3](https://github.com/trivoallan/regis-cli/compare/v0.23.2...v0.23.3) — March 30, 2026
...
- **build:** install corepack before enabling pnpm in Dockerfile ([#153](https://github.com/trivoallan/regis-cli/issues/153))

---

## [v0.23.2](https://github.com/trivoallan/regis-cli/compare/v0.23.1...v0.23.2) — March 30, 2026
...
- **build:** regenerate pnpm lockfile after Dependabot bumps ([#149](https://github.com/trivoallan/regis-cli/issues/149))

---

## [v0.23.1](https://github.com/trivoallan/regis-cli/compare/v0.23.0...v0.23.1) — March 30, 2026
...
- **ci:** remove coverage badge direct push to main ([#147](https://github.com/trivoallan/regis-cli/issues/147))

---

## [v0.23.0](https://github.com/trivoallan/regis-cli/compare/v0.22.0...v0.23.0) — March 30, 2026
...
- **ci:** add auto-rebase and auto-merge workflows for PRs ([#115](https://github.com/trivoallan/regis-cli/issues/115))
- **ci:** auto-rebase Dependabot PRs via [@dependabot](https://github.com/dependabot) rebase comment ([#140](https://github.com/trivoallan/regis-cli/issues/140))
- **ci:** skip schema/rules doc generation when source unchanged ([#139](https://github.com/trivoallan/regis-cli/issues/139))

### 🐛 Bug Fixes

- **ci:** fall back to github.token when App secrets unavailable (dependabot PRs) ([#137](https://github.com/trivoallan/regis-cli/issues/137))
- **ci:** remove broken [@dependabot](https://github.com/dependabot) rebase comment approach ([#142](https://github.com/trivoallan/regis-cli/issues/142))
- **ci:** revert actions/create-github-app-token to v1 in docs-publish workflow ([#106](https://github.com/trivoallan/regis-cli/issues/106))
- **ci:** skip auto-merge for release-please PRs ([#144](https://github.com/trivoallan/regis-cli/issues/144))
- **ci:** use GitHub App token for Trunk auto-commit to trigger new workflow runs ([#108](https://github.com/trivoallan/regis-cli/issues/108))
- **ci:** use personal_token for peaceiris/actions-gh-pages in docs-publish ([#113](https://github.com/trivoallan/regis-cli/issues/113))
- **ci:** use pull_request_target so auto-merge works on Dependabot PRs ([#143](https://github.com/trivoallan/regis-cli/issues/143))
...
- **ci:** remove broken [@dependabot](https://github.com/dependabot) rebase comment approach ([#141](https://github.com/trivoallan/regis-cli/issues/141))

### 📚 Documentation

- Add CI/CD gotchas for Dependabot, Release Please, and auto-rebase
- **ci:** update memory bank with GitHub Actions auth unification ([#114](https://github.com/trivoallan/regis-cli/issues/114))
- Snapshot versioned docs for v0.22.0
- Update documentation reference and snapshots ([#103](https://github.com/trivoallan/regis-cli/issues/103))
- Update documentation reference and snapshots ([#107](https://github.com/trivoallan/regis-cli/issues/107))
- Update documentation reference and snapshots ([#109](https://github.com/trivoallan/regis-cli/issues/109))
- Update documentation reference and snapshots ([#110](https://github.com/trivoallan/regis-cli/issues/110))
- Update documentation reference and snapshots ([#112](https://github.com/trivoallan/regis-cli/issues/112))
- Update documentation reference and snapshots ([#116](https://github.com/trivoallan/regis-cli/issues/116))
- Update documentation reference and snapshots ([#118](https://github.com/trivoallan/regis-cli/issues/118))
- Update documentation reference and snapshots ([#135](https://github.com/trivoallan/regis-cli/issues/135))

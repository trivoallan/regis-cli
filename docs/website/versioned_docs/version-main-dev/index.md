...
For a detailed look at how the tool works and its internal structure, see the [Architectural Overview](./overview/architecture) and [Understand Playbooks](./overview/playbooks).
